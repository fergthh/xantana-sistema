...
Begin VB.Form PrgLineaInsumo 
   AutoRedraw      =   -1  'True
   Caption         =   "Ingreso de Lineas de Insumos"
   ClientHeight    =   5355
   ClientLeft      =   1050
   ClientTop       =   690
   ClientWidth     =   9765
   ...
   Begin VB.CommandButton Ultimo 
      ...
      Height          =   975
      Left            =   6840
      MouseIcon       =   "Ubicaciones.frx":0000
      MousePointer    =   99  'Custom
      Picture         =   "Ubicaciones.frx":030A
      Style           =   1  'Graphical
      TabIndex        =   24
      ToolTipText     =   "Salida"
      Top             =   1080
   ...
   Begin VB.CommandButton Siguiente 
      ...
      Height          =   975
      Left            =   5880
      MouseIcon       =   "Ubicaciones.frx":074C
      MousePointer    =   99  'Custom
      Picture         =   "Ubicaciones.frx":0A56
      Style           =   1  'Graphical
      TabIndex        =   23
   ...
   Begin VB.CommandButton Anterior 
      ...
      Height          =   975
      Left            =   4920
      MouseIcon       =   "Ubicaciones.frx":0E98
      MousePointer    =   99  'Custom
      Picture         =   "Ubicaciones.frx":11A2
      Style           =   1  'Graphical
      TabIndex        =   22
   ...
   Begin VB.CommandButton Primer 
      ...
      Height          =   975
      Left            =   3960
      MouseIcon       =   "Ubicaciones.frx":15E4
      MousePointer    =   99  'Custom
      Picture         =   "Ubicaciones.frx":18EE
      Style           =   1  'Graphical
      TabIndex        =   21
   ...
   Begin VB.CommandButton CmdClose 
      ...
      Height          =   975
      Left            =   8760
      MouseIcon       =   "Ubicaciones.frx":1D30
      MousePointer    =   99  'Custom
      Picture         =   "Ubicaciones.frx":203A
      Style           =   1  'Graphical
      TabIndex        =   20
      ToolTipText     =   "Salida"
      Top             =   1080
   ...
   Begin VB.CommandButton Lista 
      ...
      Height          =   975
      Left            =   7800
      MouseIcon       =   "Ubicaciones.frx":287C
      MousePointer    =   99  'Custom
      Picture         =   "Ubicaciones.frx":2B86
      Style           =   1  'Graphical
      TabIndex        =   19
   ...
   Begin VB.CommandButton Consulta 
      ...
      Height          =   975
      Left            =   3000
      MouseIcon       =   "Ubicaciones.frx":33C8
      MousePointer    =   99  'Custom
      Picture         =   "Ubicaciones.frx":36D2
      Style           =   1  'Graphical
      TabIndex        =   18
   ...
   Begin VB.CommandButton CmdLimpiar 
      ...
      Height          =   975
      Left            =   2040
      MouseIcon       =   "Ubicaciones.frx":3F14
      MousePointer    =   99  'Custom
      Picture         =   "Ubicaciones.frx":421E
      Style           =   1  'Graphical
      TabIndex        =   17
   ...
   Begin VB.CommandButton CmdDelete 
      ...
      Height          =   975
      Left            =   1080
      MouseIcon       =   "Ubicaciones.frx":4A60
      MousePointer    =   99  'Custom
      Picture         =   "Ubicaciones.frx":4D6A
      Style           =   1  'Graphical
      TabIndex        =   16
   ...
   Begin VB.CommandButton CmdAdd 
      ...
      Height          =   975
      Left            =   120
      MouseIcon       =   "Ubicaciones.frx":55AC
      MousePointer    =   99  'Custom
      Picture         =   "Ubicaciones.frx":58B6
      Style           =   1  'Graphical
      TabIndex        =   15
   ...
   Begin VB.Frame Frame2 
      ...
      Begin VB.CommandButton Cancela 
         ...
         Height          =   975
         Left            =   4080
         MouseIcon       =   "Ubicaciones.frx":60F8
         MousePointer    =   99  'Custom
         Picture         =   "Ubicaciones.frx":6402
         Style           =   1  'Graphical
         TabIndex        =   26
         ToolTipText     =   "Graba los Datos Ingresados"
         Top             =   480
      ...
      Begin VB.CommandButton Acepta 
         ...
         Height          =   975
         Left            =   3000
         MouseIcon       =   "Ubicaciones.frx":6844
         MousePointer    =   99  'Custom
         Picture         =   "Ubicaciones.frx":6B4E
         Style           =   1  'Graphical
         TabIndex        =   25
         ToolTipText     =   "Graba los Datos Ingresados"
         Top             =   480
   ...
   Begin VB.ListBox Pantalla 
      ...
      EndProperty
      Height          =   2460
      ItemData        =   "Ubicaciones.frx":6F90
      Left            =   240
      List            =   "Ubicaciones.frx":6F97
      TabIndex        =   4
      Top             =   2640
      Visible         =   0   'False
      Width           =   6735
...
Private Sub Acepta_Click()
    ...
    Listado.WindowTitle = "Listado de Lineas de Insumos"
    Listado.WindowTop = 0
...
Private Sub Consulta_Click()
     ...
     Opcion.AddItem "Lineas de Insumos"
...
Private Sub Anterior_Click()
    ...
    If rstLineaInsumo.RecordCount > 0 Then
        ...
        a% = MsgBox(m$, 0, "Archivo de LineaInsumo de Venta")
    End If
End Sub
