...
Begin VB.Form PrgValua 
   AutoRedraw      =   -1  'True
   Caption         =   "Listado de Valuacion de  Stock"
   ClientHeight    =   6825
   ClientLeft      =   1890
   ClientTop       =   1080
   ClientWidth     =   8145
   ...
   Begin VB.Frame Frame2 
      ...
      Begin VB.CommandButton Cancela 
         ...
         Height          =   975
         Left            =   3840
         MouseIcon       =   "Valua.frx":0000
         MousePointer    =   99  'Custom
         Picture         =   "Valua.frx":030A
         Style           =   1  'Graphical
         TabIndex        =   11
         ToolTipText     =   "Salida"
         Top             =   1440
      ...
      Begin VB.CommandButton Impre 
         ...
         Height          =   975
         Left            =   1440
         MouseIcon       =   "Valua.frx":0B4C
         MousePointer    =   99  'Custom
         Picture         =   "Valua.frx":0E56
         Style           =   1  'Graphical
         TabIndex        =   10
      ...
      Begin VB.CommandButton Consulta 
         ...
         Height          =   975
         Left            =   2640
         MouseIcon       =   "Valua.frx":1698
         MousePointer    =   99  'Custom
         Picture         =   "Valua.frx":19A2
         Style           =   1  'Graphical
         TabIndex        =   9
      ...
      Begin VB.CommandButton Panta 
         ...
         Height          =   975
         Left            =   240
         MouseIcon       =   "Valua.frx":21E4
         MousePointer    =   99  'Custom
         Picture         =   "Valua.frx":24EE
         Style           =   1  'Graphical
         TabIndex        =   8
...
Private Sub Proceso_Click()
    ...
    Listado.WindowTitle = "Lista de Valuacion de Stock"
    Listado.WindowTop = 0
    ...
    Listado.SQLQuery = "SELECT Articulo.Codigo, Articulo.Descripcion, Articulo.Stock, Articulo.Costo, Articulo.Linea, " _
                + "Lineas.Nombre, " _
                + "Auxiliar.Nombre " _
                + "From " _
