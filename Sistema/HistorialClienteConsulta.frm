...
Begin VB.Form PrgHistorialClienteConsulta 
   AutoRedraw      =   -1  'True
   ...
   Begin VB.CommandButton CmdClose 
      ...
      Height          =   975
      Left            =   7320
      MouseIcon       =   "HistorialClienteConsulta.frx":0000
      MousePointer    =   99  'Custom
      Picture         =   "HistorialClienteConsulta.frx":030A
      Style           =   1  'Graphical
      TabIndex        =   0
   ...
   Begin VB.ListBox Pantalla 
      ...
      EndProperty
      Height          =   1740
      ItemData        =   "HistorialClienteConsulta.frx":0B4C
      Left            =   120
      List            =   "HistorialClienteConsulta.frx":0B53
      TabIndex        =   2
      Top             =   6240
      Visible         =   0   'False
      Width           =   6855
   ...
   End
End
Attribute VB_Name = "PrgHistorialClienteConsulta"
...
Private Sub cmdClose_Click()
    PrgHistorialClienteConsulta.Hide
    Unload Me
...
Private Sub Graba_Click()
    ...
    For IRow = 1 To 1000
        ...
        If Fecha <> "" Or Observaciones <> "" Then
                    
            Renglon = Renglon + 1
            Auxi = Str$(Renglon)
            Call Ceros(Auxi, 3)
                    
            ZZClave = Cliente.Text + Auxi
    ...
    ZSql = ZSql + " Marca = " + "'" + Str$(Marca.ListIndex) + "'"
...
Private Sub Proceso_Click()
    ...
    ZSql = ZSql + " Where HistorialCliente.Cliente = " + "'" + Cliente.Text + "'"
    ZSql = ZSql + " Order by HistorialCliente.Clave"
    spHistorialCliente = ZSql
    Set rstHistorialCliente = db.OpenRecordset(spHistorialCliente, dbOpenSnapshot, dbSQLPassThrough)
    If rstHistorialCliente.RecordCount > 0 Then
    
        With rstHistorialCliente
            .MoveFirst
            Do
                If .EOF = False Then
