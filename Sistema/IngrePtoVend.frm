...
Begin VB.Form PrgIngrePtoVend 
   AutoRedraw      =   -1  'True
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Ingreso de Presupuesto de Ventas por Vendedor"
   ClientHeight    =   8175
   ClientLeft      =   330
   ClientTop       =   555
   ClientWidth     =   11160
   ...
   Begin VB.ListBox Pantalla 
      ...
      EndProperty
      Height          =   1740
      ItemData        =   "IngrePtoVend.frx":0000
      Left            =   120
      List            =   "IngrePtoVend.frx":0007
      TabIndex        =   1
      Top             =   6240
      Visible         =   0   'False
      Width           =   6855
   ...
   Begin VB.Image Borra 
      Height          =   480
      Left            =   10320
      MouseIcon       =   "IngrePtoVend.frx":0015
      MousePointer    =   99  'Custom
      Picture         =   "IngrePtoVend.frx":031F
   ...
   Begin VB.Image Graba 
      Height          =   480
      Left            =   10320
      MouseIcon       =   "IngrePtoVend.frx":0B61
      MousePointer    =   99  'Custom
      Picture         =   "IngrePtoVend.frx":0E6B
   ...
   Begin VB.Image CmdClose 
      Height          =   480
      Left            =   10320
      MouseIcon       =   "IngrePtoVend.frx":16AD
      MousePointer    =   99  'Custom
      Picture         =   "IngrePtoVend.frx":19B7
      ToolTipText     =   "Salida"
      Top             =   4320
      Width           =   480
   End
   Begin VB.Image Consulta 
      Height          =   480
      Left            =   10320
      MouseIcon       =   "IngrePtoVend.frx":21F9
      MousePointer    =   99  'Custom
      Picture         =   "IngrePtoVend.frx":2503
   ...
   Begin VB.Image Limpia 
      Height          =   480
      Left            =   10320
      MouseIcon       =   "IngrePtoVend.frx":2D45
      MousePointer    =   99  'Custom
      Picture         =   "IngrePtoVend.frx":304F
   ...
   End
End
Attribute VB_Name = "PrgIngrePtoVend"
...
Private Sub Graba_Click()
    ...
    With rstPtoVend
        ...
        For iRow = 1 To 100
            ...
            WVendedor = Val(WVector1.TextMatrix(iRow, 1))
            WImporte = Val(WVector1.TextMatrix(iRow, 3))
                    
            If WVendedor <> 0 Or WImporte <> 0 Then
...
Private Sub Vendedor_DblClick()

    Opcion.Clear
    Opcion.AddItem "Venededores"
