...
Begin VB.Form PrgEstaProv 
   ...
   Begin VB.Frame Frame2 
      ...
      Begin VB.CommandButton Cancela 
         ...
         Height          =   975
         Left            =   3960
         MouseIcon       =   "EstaProvArt.frx":0000
         MousePointer    =   99  'Custom
         Picture         =   "EstaProvArt.frx":030A
         Style           =   1  'Graphical
         TabIndex        =   16
         ToolTipText     =   "Salida"
         Top             =   3000
      ...
      Begin VB.CommandButton Impre 
         ...
         Height          =   975
         Left            =   1560
         MouseIcon       =   "EstaProvArt.frx":0B4C
         MousePointer    =   99  'Custom
         Picture         =   "EstaProvArt.frx":0E56
         Style           =   1  'Graphical
         TabIndex        =   15
      ...
      Begin VB.CommandButton Consulta 
         ...
         Height          =   975
         Left            =   2760
         MouseIcon       =   "EstaProvArt.frx":1698
         MousePointer    =   99  'Custom
         Picture         =   "EstaProvArt.frx":19A2
         Style           =   1  'Graphical
         TabIndex        =   14
      ...
      Begin VB.CommandButton Panta 
         ...
         Height          =   975
         Left            =   360
         MouseIcon       =   "EstaProvArt.frx":21E4
         MousePointer    =   99  'Custom
         Picture         =   "EstaProvArt.frx":24EE
         Style           =   1  'Graphical
         TabIndex        =   13
   ...
   Begin VB.ListBox Pantalla 
      ...
      EndProperty
      Height          =   1980
      ItemData        =   "EstaProvArt.frx":2D30
      Left            =   840
      List            =   "EstaProvArt.frx":2D37
      TabIndex        =   1
      Top             =   4920
      Visible         =   0   'False
      Width           =   6735
