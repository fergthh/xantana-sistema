...
Begin VB.Form PrgSolicitudOrdenCompra 
   AutoRedraw      =   -1  'True
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Solicitud de Orden de Compra"
   ClientHeight    =   8175
   ClientLeft      =   195
   ClientTop       =   375
   ClientWidth     =   14370
   ...
   Begin VB.CommandButton ImpresionII 
      ...
      Height          =   975
      Left            =   13320
      MouseIcon       =   "SolicitudOrdenCompra.frx":0000
      MousePointer    =   99  'Custom
      Picture         =   "SolicitudOrdenCompra.frx":030A
      Style           =   1  'Graphical
      TabIndex        =   22
   ...
   Begin VB.CommandButton Graba 
      ...
      Height          =   975
      Left            =   13320
      MouseIcon       =   "SolicitudOrdenCompra.frx":0B4C
      MousePointer    =   99  'Custom
      Picture         =   "SolicitudOrdenCompra.frx":0E56
      Style           =   1  'Graphical
      TabIndex        =   21
   ...
   Begin VB.CommandButton Limpia 
      ...
      Height          =   975
      Left            =   13320
      MouseIcon       =   "SolicitudOrdenCompra.frx":1698
      MousePointer    =   99  'Custom
      Picture         =   "SolicitudOrdenCompra.frx":19A2
      Style           =   1  'Graphical
      TabIndex        =   20
   ...
   Begin VB.CommandButton Consulta 
      ...
      Height          =   975
      Left            =   13320
      MouseIcon       =   "SolicitudOrdenCompra.frx":21E4
      MousePointer    =   99  'Custom
      Picture         =   "SolicitudOrdenCompra.frx":24EE
      Style           =   1  'Graphical
      TabIndex        =   19
   ...
   Begin VB.CommandButton CmdClose 
      ...
      Height          =   975
      Left            =   13320
      MouseIcon       =   "SolicitudOrdenCompra.frx":2D30
      MousePointer    =   99  'Custom
      Picture         =   "SolicitudOrdenCompra.frx":303A
      Style           =   1  'Graphical
      TabIndex        =   18
   ...
   Begin VB.ListBox Pantalla 
      ...
      EndProperty
      Height          =   1740
      ItemData        =   "SolicitudOrdenCompra.frx":387C
      Left            =   120
      List            =   "SolicitudOrdenCompra.frx":3883
      TabIndex        =   1
      Top             =   6240
      Visible         =   0   'False
      Width           =   6855
   ...
   End
End
Attribute VB_Name = "PrgSolicitudOrdenCompra"
...
Private Sub Graba_Click()
    ...
    For WRenglon = 1 To 100
        ...
        ZSql = ZSql + " Where Solicitud.Clave = " + "'" + WClave + "'"
        spSolicitud = ZSql
        Set rstSolicitud = db.OpenRecordset(spSolicitud, dbOpenSnapshot, dbSQLPassThrough)
        If rstSolicitud.RecordCount > 0 Then
            ZZPedido = rstSolicitud!Pedido
            ZZMarca = rstSolicitud!Marca
            rstSolicitud.Close
            If ZZPedido <> 0 Or ZZMarca = "X" Then
                Rem m$ = "No se puede modificar la solicitud por que ya se encuentra procesada"
                Rem aaaaaa% = MsgBox(m$, 0, "Archivo de Solicitud de Ordenes de Compra")
                Rem Exit Sub
            End If
    ...
    ZSql = ""
    ZSql = ZSql + "DELETE Solicitud"
    ZSql = ZSql + " Where Solicitud.Numero = " + "'" + Numero.Text + "'"
    spSolicitud = ZSql
    Set rstSolicitud = db.OpenRecordset(spSolicitud, dbOpenSnapshot, dbSQLPassThrough)
    ...
    For IRow = 1 To 100
        ...
        WVector1.Col = 4
        Ajuste = Val(WVector1.Text)
                    
        WVector1.Col = 5
        Pedido = Val(WVector1.Text)
        ...
        If Cantidad <> 0 Then
            ...
            ZSql = ""
            ZSql = ZSql + "INSERT INTO Solicitud ("
            ZSql = ZSql + "Clave ,"
            ZSql = ZSql + "Numero ,"
            ZSql = ZSql + "Renglon ,"
            ZSql = ZSql + "fecha ,"
    ...
    aaaaaa% = MsgBox(m$, 0, "Archivo de Solicitud de Ordenes de Compra")
...
Private Sub Impresion()
    ...
    Listado.SQLQuery = "SELECT Solicitud.Clave, Solicitud.Numero, Solicitud.Renglon, Solicitud.Fecha, Solicitud.Insumo, Solicitud.Cantidad, Solicitud.Observaciones, " _
            ...
            + "Solicitud.Numero >= " + Numero.Text + " AND " _
            + "Solicitud.Numero <= " + Numero.Text
    
    Listado.Connect = Connect()
    
    Uno = "{Solicitud.Numero} in " + Numero.Text + " to " + Numero.Text
    
    Listado.GroupSelectionFormula = Uno
    Listado.SelectionFormula = Uno
            
    Listado.ReportFileName = "Solicitudordencompra.rpt"
...
Private Sub Limpia_Click()
    ...
    Set rstSolicitud = db.OpenRecordset(spSolicitud, dbOpenSnapshot, dbSQLPassThrough)
    If rstSolicitud.RecordCount > 0 Then
        rstSolicitud.MoveLast
        ZUltimo = IIf(IsNull(rstSolicitud!NumeroMayor), "0", rstSolicitud!NumeroMayor)
...
Private Sub Proceso_Click()
    ...
    For WRenglon = 1 To 100
        ...
        If rstSolicitud.RecordCount > 0 Then
            ...
            WVector1.Col = 1
            WVector1.Text = rstSolicitud!Insumo
            Auxi1 = rstSolicitud!Insumo
                
            WVector1.Col = 3
            WVector1.Text = Pusing("###,###.##", Str$(rstSolicitud!Cantidad))
        
            ZZAjuste = IIf(IsNull(rstSolicitud!Ajuste), "0", rstSolicitud!Ajuste)
            WVector1.Col = 4
            WVector1.Text = Pusing("###,###.##", Str$(ZZAjuste))
        
            ZZPedido = IIf(IsNull(rstSolicitud!Pedido), "0", rstSolicitud!Pedido)
            WVector1.Col = 5
            WVector1.Text = Pusing("###,###.##", Str$(ZZPedido))
...
Private Sub Numero_Keypress(KeyAscii As Integer)
    If KeyAscii = 13 Then
        ...
        ZSql = ZSql + "Select *"
        ZSql = ZSql + " FROM Solicitud"
        ZSql = ZSql + " Where Solicitud.Numero = " + "'" + Auxi + "'"
        spSolicitud = ZSql
        Set rstSolicitud = db.OpenRecordset(spSolicitud, dbOpenSnapshot, dbSQLPassThrough)
        If rstSolicitud.RecordCount > 0 Then
            
            Fecha.Text = rstSolicitud!Fecha
            Observaciones.Text = rstSolicitud!Observaciones
