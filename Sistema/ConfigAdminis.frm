...
Begin VB.Form PrgConfigAdminis 
   AutoRedraw      =   -1  'True
   ...
   Begin TabDlg.SSTab Tablas 
      ...
      TabHeight       =   520
      TabCaption(0)   =   "Tab 0"
      TabPicture(0)   =   "ConfigAdminis.frx":0000
      ...
      TabCaption(1)   =   "Tab 1"
      TabPicture(1)   =   "ConfigAdminis.frx":001C
      Tab(1).ControlCount=   12
      Tab(1).ControlEnabled=   0   'False
      Tab(1).Control(0)=   "Opcion15"
      Tab(1).Control(0).Enabled=   -1  'True
      Tab(1).Control(1)=   "Opcion16"
      Tab(1).Control(1).Enabled=   -1  'True
      Tab(1).Control(2)=   "Opcion14"
      Tab(1).Control(2).Enabled=   -1  'True
      Tab(1).Control(3)=   "Opcion13"
      Tab(1).Control(3).Enabled=   -1  'True
      Tab(1).Control(4)=   "Opcion12"
      Tab(1).Control(4).Enabled=   -1  'True
      Tab(1).Control(5)=   "Opcion11"
      Tab(1).Control(5).Enabled=   -1  'True
      Tab(1).Control(6)=   "Titulo15"
      Tab(1).Control(6).Enabled=   0   'False
      Tab(1).Control(7)=   "Titulo16"
      Tab(1).Control(7).Enabled=   0   'False
      Tab(1).Control(8)=   "Titulo14"
      Tab(1).Control(8).Enabled=   0   'False
      Tab(1).Control(9)=   "Titulo13"
      Tab(1).Control(9).Enabled=   0   'False
      Tab(1).Control(10)=   "Titulo12"
      Tab(1).Control(10).Enabled=   0   'False
      Tab(1).Control(11)=   "Titulo11"
      Tab(1).Control(11).Enabled=   0   'False
      TabCaption(2)   =   "Tab 2"
      TabPicture(2)   =   "ConfigAdminis.frx":0038
      Tab(2).ControlCount=   38
      Tab(2).ControlEnabled=   0   'False
      Tab(2).Control(0)=   "Opcion216"
      Tab(2).Control(0).Enabled=   -1  'True
      Tab(2).Control(1)=   "Opcion215"
      Tab(2).Control(1).Enabled=   -1  'True
      Tab(2).Control(2)=   "Opcion214"
      Tab(2).Control(2).Enabled=   -1  'True
      Tab(2).Control(3)=   "Opcion213"
      Tab(2).Control(3).Enabled=   -1  'True
      Tab(2).Control(4)=   "Opcion219"
      Tab(2).Control(4).Enabled=   -1  'True
      Tab(2).Control(5)=   "Opcion218"
      Tab(2).Control(5).Enabled=   -1  'True
      Tab(2).Control(6)=   "Opcion217"
      Tab(2).Control(6).Enabled=   -1  'True
      Tab(2).Control(7)=   "Opcion29"
      Tab(2).Control(7).Enabled=   -1  'True
      Tab(2).Control(8)=   "Opcion210"
      Tab(2).Control(8).Enabled=   -1  'True
      Tab(2).Control(9)=   "Opcion211"
      Tab(2).Control(9).Enabled=   -1  'True
      Tab(2).Control(10)=   "Opcion212"
      Tab(2).Control(10).Enabled=   -1  'True
      Tab(2).Control(11)=   "Opcion25"
      Tab(2).Control(11).Enabled=   -1  'True
      Tab(2).Control(12)=   "Opcion26"
      Tab(2).Control(12).Enabled=   -1  'True
      Tab(2).Control(13)=   "Opcion27"
      Tab(2).Control(13).Enabled=   -1  'True
      Tab(2).Control(14)=   "Opcion28"
      Tab(2).Control(14).Enabled=   -1  'True
      Tab(2).Control(15)=   "opcion21"
      Tab(2).Control(15).Enabled=   -1  'True
      Tab(2).Control(16)=   "Opcion22"
      Tab(2).Control(16).Enabled=   -1  'True
      Tab(2).Control(17)=   "Opcion23"
      Tab(2).Control(17).Enabled=   -1  'True
      Tab(2).Control(18)=   "Opcion24"
      Tab(2).Control(18).Enabled=   -1  'True
      Tab(2).Control(19)=   "Titulo216"
      Tab(2).Control(19).Enabled=   0   'False
      Tab(2).Control(20)=   "Titulo215"
      Tab(2).Control(20).Enabled=   0   'False
      Tab(2).Control(21)=   "Titulo214"
      Tab(2).Control(21).Enabled=   0   'False
      Tab(2).Control(22)=   "Titulo213"
      Tab(2).Control(22).Enabled=   0   'False
      Tab(2).Control(23)=   "Titulo219"
      Tab(2).Control(23).Enabled=   0   'False
      Tab(2).Control(24)=   "Titulo218"
      Tab(2).Control(24).Enabled=   0   'False
      Tab(2).Control(25)=   "Titulo217"
      Tab(2).Control(25).Enabled=   0   'False
      Tab(2).Control(26)=   "Titulo29"
      Tab(2).Control(26).Enabled=   0   'False
      Tab(2).Control(27)=   "Titulo210"
      Tab(2).Control(27).Enabled=   0   'False
      Tab(2).Control(28)=   "Titulo211"
      Tab(2).Control(28).Enabled=   0   'False
      Tab(2).Control(29)=   "Titulo212"
      Tab(2).Control(29).Enabled=   0   'False
      Tab(2).Control(30)=   "Titulo25"
      Tab(2).Control(30).Enabled=   0   'False
      Tab(2).Control(31)=   "Titulo26"
      Tab(2).Control(31).Enabled=   0   'False
      Tab(2).Control(32)=   "Titulo27"
      Tab(2).Control(32).Enabled=   0   'False
      Tab(2).Control(33)=   "Titulo28"
      Tab(2).Control(33).Enabled=   0   'False
      Tab(2).Control(34)=   "Titulo21"
      Tab(2).Control(34).Enabled=   0   'False
      Tab(2).Control(35)=   "Titulo22"
      Tab(2).Control(35).Enabled=   0   'False
      Tab(2).Control(36)=   "Titulo23"
      Tab(2).Control(36).Enabled=   0   'False
      Tab(2).Control(37)=   "Titulo24"
      Tab(2).Control(37).Enabled=   0   'False
      TabCaption(3)   =   "Tab 3"
      TabPicture(3)   =   "ConfigAdminis.frx":0054
   ...
   End
End
Attribute VB_Name = "PrgConfigAdminis"
...
Sub Form_Load()
    ...
    Titulo15.Caption = "Ingresos de Debitos y Creditos Bancarios"
