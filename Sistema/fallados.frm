...
Begin VB.Form PrgFallados 
   AutoRedraw      =   -1  'True
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Ingreso de Fallados"
   ClientHeight    =   8175
   ClientLeft      =   930
   ClientTop       =   375
   ClientWidth     =   9615
   ...
   Begin VB.CommandButton Graba 
      ...
      Height          =   975
      Left            =   7800
      MouseIcon       =   "fallados.frx":0000
      MousePointer    =   99  'Custom
      Picture         =   "fallados.frx":030A
      Style           =   1  'Graphical
      TabIndex        =   21
   ...
   Begin VB.CommandButton Limpia 
      ...
      Height          =   975
      Left            =   7800
      MouseIcon       =   "fallados.frx":0B4C
      MousePointer    =   99  'Custom
      Picture         =   "fallados.frx":0E56
      Style           =   1  'Graphical
      TabIndex        =   20
   ...
   Begin VB.CommandButton Consulta 
      ...
      Height          =   975
      Left            =   7800
      MouseIcon       =   "fallados.frx":1698
      MousePointer    =   99  'Custom
      Picture         =   "fallados.frx":19A2
      Style           =   1  'Graphical
      TabIndex        =   19
   ...
   Begin VB.CommandButton CmdClose 
      ...
      Height          =   975
      Left            =   7800
      MouseIcon       =   "fallados.frx":21E4
      MousePointer    =   99  'Custom
      Picture         =   "fallados.frx":24EE
      Style           =   1  'Graphical
      TabIndex        =   18
   ...
   Begin VB.ListBox Pantalla 
      ...
      EndProperty
      Height          =   1740
      ItemData        =   "fallados.frx":2D30
      Left            =   120
      List            =   "fallados.frx":2D37
      TabIndex        =   1
      Top             =   6240
      Visible         =   0   'False
      Width           =   6855
...
Private Sub Graba_Click()
    ...
    For WRenglon = 1 To 100
        ...
        If rstProduccion.RecordCount > 0 Then
            ...
            ZSql = ZSql + " StockIII = StockIII - " + "'" + Str$(WCantidad) + "',"
            ZSql = ZSql + " StockIV = StockIV - " + "'" + Str$(WCantidad) + "'"
    ...
    For iRow = 1 To 100
        ...
        If Cantidad <> 0 Then
            ...
            ZSql = ZSql + " StockIII = StockIII + " + "'" + Str$(ZZCantidad) + "',"
            ZSql = ZSql + " StockIV = StockIV + " + "'" + Str$(ZZCantidad) + "'"
...
Private Sub Impresion()
    ...
    Listado.SQLQuery = "SELECT Produccion.Numero, Produccion.Renglon, Produccion.Articulo, Produccion.Cantidad, Produccion.Observaciones, " _
    ...
    Listado.ReportFileName = "Produccion.rpt"
