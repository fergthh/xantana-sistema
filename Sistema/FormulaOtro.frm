...
Begin VB.Form PrgFormulaOtro 
   ...
   Begin VB.CommandButton Graba 
      ...
      Height          =   975
      Left            =   10440
      MouseIcon       =   "FormulaOtro.frx":0000
      MousePointer    =   99  'Custom
      Picture         =   "FormulaOtro.frx":030A
      Style           =   1  'Graphical
      TabIndex        =   17
   ...
   Begin VB.CommandButton Limpia 
      ...
      Height          =   975
      Left            =   10440
      MouseIcon       =   "FormulaOtro.frx":0B4C
      MousePointer    =   99  'Custom
      Picture         =   "FormulaOtro.frx":0E56
      Style           =   1  'Graphical
      TabIndex        =   16
   ...
   Begin VB.CommandButton Consulta 
      ...
      Height          =   975
      Left            =   10440
      MouseIcon       =   "FormulaOtro.frx":1698
      MousePointer    =   99  'Custom
      Picture         =   "FormulaOtro.frx":19A2
      Style           =   1  'Graphical
      TabIndex        =   15
   ...
   Begin VB.CommandButton CmdClose 
      ...
      Height          =   975
      Left            =   10440
      MouseIcon       =   "FormulaOtro.frx":21E4
      MousePointer    =   99  'Custom
      Picture         =   "FormulaOtro.frx":24EE
      Style           =   1  'Graphical
      TabIndex        =   14
   ...
   Begin VB.ListBox Pantalla 
      ...
      EndProperty
      Height          =   1740
      ItemData        =   "FormulaOtro.frx":2D30
      Left            =   120
      List            =   "FormulaOtro.frx":2D37
      TabIndex        =   1
      Top             =   6240
      Visible         =   0   'False
      Width           =   6855
   ...
   End
End
Attribute VB_Name = "PrgFormulaOtro"
...
Private Sub Graba_Click()
    ...
    ZSql = ""
    ZSql = ZSql + "DELETE FormulaII"
    ZSql = ZSql + " Where FormulaII.Articulo = " + "'" + Articulo.Text + "'"
    spFormulaII = ZSql
    Set rstFormulaII = db.OpenRecordset(spFormulaII, dbOpenSnapshot, dbSQLPassThrough)
    ...
    For IRow = 1 To 100
        ...
        If Cantidad <> 0 Then
            ...
            ZZCantidadII = Str$(CantidadII)
            
            ZZClave = Trim(Articulo.Text) + Auxi
            
            ZSql = ""
            ZSql = ZSql + "INSERT INTO FormulaII ("
            ZSql = ZSql + "Clave ,"
            ZSql = ZSql + "Articulo ,"
            ZSql = ZSql + "Renglon ,"
            ZSql = ZSql + "Insumo ,"
...
Private Sub Proceso_Click()
    ...
    For WRenglon = 1 To 100
        ...
        ZSql = ""
        ZSql = ZSql + "Select *"
        ZSql = ZSql + " FROM FormulaII"
        ZSql = ZSql + " Where FormulaII.Clave = " + "'" + WClave + "'"
        spFormulaII = ZSql
        Set rstFormulaII = db.OpenRecordset(spFormulaII, dbOpenSnapshot, dbSQLPassThrough)
        If rstFormulaII.RecordCount > 0 Then
            ...
            WVector1.Col = 1
            WVector1.Text = rstFormulaII!Insumo
            Auxi = rstFormulaII!Insumo
                
            WVector1.Col = 3
            WVector1.Text = Pusing("###,###", Str$(rstFormulaII!Cantidad))
            ZZCantidad = rstFormulaII!Cantidad
                
            WVector1.Col = 4
            WVector1.Text = Pusing("###,###", Str$(rstFormulaII!CantidadII))
            ZZCantidadII = rstFormulaII!CantidadII
            ...
            If rstInsumo.RecordCount > 0 Then
                ...
                If ZZCantidadII <> 0 Then
                    ZZCosto = (rstInsumo!Costo * ZZCantidad) / ZZCantidadII
                        Else
                    ZZCosto = (rstInsumo!Costo * ZZCantidad)
                End If
                WVector1.Col = 5
                WVector1.Text = Pusing("###,###.##", Str$(rstInsumo!Costo))
                WVector1.Col = 6
                WVector1.Text = Pusing("###,###.##", Str$(ZZCosto))
                rstInsumo.Close
            End If
    ...
    Select Case XColumna
        Case 1
            ...
            If rstInsumo.RecordCount > 0 Then
                WVector1.Col = 2
                WVector1.Text = rstInsumo!Descripcion
                ZZCantidad = Val(WVector1.TextMatrix(WVector1.Row, 3))
                ZZCantidadII = Val(WVector1.TextMatrix(WVector1.Row, 4))
                If ZZCantidadII <> 0 Then
                    ZZCosto = (rstInsumo!Costo * ZZCantidad) / ZZCantidadII
                        Else
                    ZZCosto = (rstInsumo!Costo * ZZCantidad)
        ...
        Case 3, 4
            ZLugar = WVector1.Col
            ZZCostoUni = Val(WVector1.TextMatrix(WVector1.Row, 5))
            ZZCosto = Val(WVector1.TextMatrix(WVector1.Row, 5))
            ZZCantidad = Val(WVector1.TextMatrix(WVector1.Row, 3))
            ZZCantidadII = Val(WVector1.TextMatrix(WVector1.Row, 4))
            If ZZCantidadII <> 0 Then
                ZZCosto = (ZZCosto * ZZCantidad) / ZZCantidadII
                    Else
                ZZCosto = (ZZCosto * ZZCantidad)
            End If
            WVector1.Col = 5
            WVector1.Text = Pusing("###,###.##", Str$(ZZCostoUni))
            WVector1.Col = 6
            WVector1.Text = Pusing("###,###.##", Str$(ZZCosto))
            WVector1.Col = 3
            WVector1.Col = ZLugar
...
Private Sub Calcula_Click()
    ...
    CostoTotal.Text = Str$(ZSuma)
    CostoTotal.Text = Pusing("###,###.##", CostoTotal.Text)
