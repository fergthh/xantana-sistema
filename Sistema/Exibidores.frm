...
Begin VB.Form PrgExibidores 
   AutoRedraw      =   -1  'True
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Composicion de Exibidores"
   ClientHeight    =   8175
   ClientLeft      =   195
   ClientTop       =   375
   ClientWidth     =   11565
   ...
   Begin VB.CommandButton Graba 
      ...
      Height          =   975
      Left            =   10440
      MouseIcon       =   "Exibidores.frx":0000
      MousePointer    =   99  'Custom
      Picture         =   "Exibidores.frx":030A
      Style           =   1  'Graphical
      TabIndex        =   17
   ...
   Begin VB.CommandButton Limpia 
      ...
      Height          =   975
      Left            =   10440
      MouseIcon       =   "Exibidores.frx":0B4C
      MousePointer    =   99  'Custom
      Picture         =   "Exibidores.frx":0E56
      Style           =   1  'Graphical
      TabIndex        =   16
   ...
   Begin VB.CommandButton Consulta 
      ...
      Height          =   975
      Left            =   10440
      MouseIcon       =   "Exibidores.frx":1698
      MousePointer    =   99  'Custom
      Picture         =   "Exibidores.frx":19A2
      Style           =   1  'Graphical
      TabIndex        =   15
   ...
   Begin VB.CommandButton CmdClose 
      ...
      Height          =   975
      Left            =   10440
      MouseIcon       =   "Exibidores.frx":21E4
      MousePointer    =   99  'Custom
      Picture         =   "Exibidores.frx":24EE
      Style           =   1  'Graphical
      TabIndex        =   14
   ...
   Begin VB.ListBox Pantalla 
      ...
      EndProperty
      Height          =   1740
      ItemData        =   "Exibidores.frx":2D30
      Left            =   120
      List            =   "Exibidores.frx":2D37
      TabIndex        =   1
      Top             =   6240
      Visible         =   0   'False
      Width           =   6855
   ...
   End
End
Attribute VB_Name = "PrgExibidores"
...
Private Sub Graba_Click()
    ...
    ZSql = ""
    ZSql = ZSql + "DELETE Exibidores"
    ZSql = ZSql + " Where Exibidores.Codigo = " + "'" + Codigo.Text + "'"
    spExibidores = ZSql
    ...
    For IRow = 1 To 100
        ...
        If Cantidad <> 0 Then
            ...
            ZZClave = Trim(ZZCodigo) + Auxi
            
            ZSql = ""
            ZSql = ZSql + "INSERT INTO Exibidores ("
            ZSql = ZSql + "Clave ,"
            ZSql = ZSql + "Codigo ,"
            ZSql = ZSql + "Renglon ,"
            ZSql = ZSql + "Articulo ,"
...
Private Sub Proceso_Click()
    ...
    For WRenglon = 1 To 100
        ...
        If rstExibidores.RecordCount > 0 Then
            ...
            WVector1.Col = 1
            WVector1.Text = Trim(rstExibidores!Articulo)
            Auxi = rstExibidores!Articulo
            
            WVector1.Col = 3
            WVector1.Text = Pusing("###,###", Str$(rstExibidores!Cantidad))
