...
Begin VB.Form PrgControlPedido 
   ...
   Begin VB.CommandButton ImpresionII 
      ...
      Height          =   975
      Left            =   12600
      MouseIcon       =   "ControlPedido.frx":0000
      MousePointer    =   99  'Custom
      Picture         =   "ControlPedido.frx":030A
      Style           =   1  'Graphical
      TabIndex        =   31
      ...
      Width           =   855
   End
   Begin VB.CommandButton FacturaProforma 
      Caption         =   "PROFORMA"
      Height          =   615
      Left            =   13200
      TabIndex        =   30
   ...
   Begin VB.CommandButton CmdClose 
      ...
      Height          =   975
      Left            =   11640
      MouseIcon       =   "ControlPedido.frx":0B4C
      MousePointer    =   99  'Custom
      Picture         =   "ControlPedido.frx":0E56
      Style           =   1  'Graphical
      TabIndex        =   11
      ToolTipText     =   "Salida"
      Top             =   480
   ...
   Begin VB.ListBox Pantalla 
      Height          =   1620
      ItemData        =   "ControlPedido.frx":1698
      Left            =   6960
      List            =   "ControlPedido.frx":169F
      TabIndex        =   1
      Top             =   480
      Width           =   4335
   End
...
Private Sub Entrega_Click()
    ...
    If WVector1.Row > 0 Then
        ZSql = ""
        ZSql = ZSql + "UPDATE Pedido SET "
        ZSql = ZSql + " Entregado = Facturado"
...
Private Sub FacturaProforma_Click()
    If WVector1.Row > 0 Then
        ZZPasaProcesoFactura = 1
        ZZNivelFactura = 1
        ZZPasaPedido = WVector1.TextMatrix(WVector1.Row, 1)
        PrgFacturaProforma.Show
    End If
End Sub
...
Private Sub ImpresionII_Click()
    ...
    ZSql = ""
    ZSql = ZSql + "UPDATE Pedido SET "
    ZSql = ZSql + " Impre = '', Impre1 = '', Impre2 = '', Impre3 = '', Impre4 = '', Impre5 = ''"
    spPedido = ZSql
    Set rstPedido = db.OpenRecordset(spPedido, dbOpenSnapshot, dbSQLPassThrough)
    ...
    For Ciclo = 1 To Renglon
        ...
        ZSql = ZSql + "UPDATE Pedido SET "
        ZSql = ZSql + " Impre = " + "'" + "X" + "',"
        ZSql = ZSql + " Impre1 = " + "'" + ZZPedidos(Ciclo, 2) + "',"
        ZSql = ZSql + " Impre2 = " + "'" + ZZPedidos(Ciclo, 3) + "',"
        ZSql = ZSql + " Impre3 = " + "'" + ZZPedidos(Ciclo, 4) + "',"
        ZSql = ZSql + " Impre4 = " + "'" + ZZPedidos(Ciclo, 5) + "',"
        ZSql = ZSql + " Impre5 = " + "'" + ZZPedidos(Ciclo, 6) + "'"
        ZSql = ZSql + " Where Pedido.Numero = " + "'" + ZZPedidos(Ciclo, 1) + "'"
        spPedido = ZSql
        Set rstPedido = db.OpenRecordset(spPedido, dbOpenSnapshot, dbSQLPassThrough)
    ...
    Listado.SQLQuery = "SELECT Pedido.Numero, Pedido.Renglon, Pedido.Cliente, Pedido.Impre, Pedido.Impre1, Pedido.Impre2, Pedido.Impre3, Pedido.Impre4, Pedido.Impre5, " _
                + "Cliente.Razon " _
                + "From " _
                ...
                + "Pedido.Renglon = 1 AND " _
                + "Pedido.Impre = 'X'"
                
    Listado.Connect = Connect()
    
    Uno = "{Pedido.Renglon} =  1"
    Dos = " and {Pedido.Impre} = 'X'"
    
    Listado.GroupSelectionFormula = Uno + Dos
    Listado.SelectionFormula = Uno + Dos
    
    Listado.ReportFileName = "ControlPedido.rpt"
...
Private Sub Proceso_Click()
    ...
    ZSql = ""
    ZSql = ZSql + "Select Pedido.OrdFecha, Pedido.Cliente, Pedido.Numero, Pedido.Fecha, Pedido.Cantidad, Pedido.Ajuste, Pedido.Facturado, Pedido.Fabrica, Pedido.Entregado, Pedido.Precio, Pedido.MarcaII, Pedido.Marca"
        ...
        With rstPedido
            ...
            Do
                If .EOF = False Then
                    ...
                    Rem If rstPedido!Numero = 54913 Then Stop
