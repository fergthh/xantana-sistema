...
Begin VB.Form Menu4 
   ...
   EndProperty
   Icon            =   "menuinsu4.frx":0000
   LinkTopic       =   "Form1"
   MouseIcon       =   "menuinsu4.frx":0442
   ScaleHeight     =   8310
   ScaleWidth      =   11640
   ...
   Begin VB.Label Label6 
      Alignment       =   2  'Center
      BackColor       =   &H00FFFF00&
      Caption         =   "5) Insumos por Proveedor"
      BeginProperty Font 
         Name            =   "MS Sans Serif"
         Size            =   13.5
         Charset         =   0
   ...
   Begin VB.Label Label3 
      Alignment       =   2  'Center
      BackColor       =   &H00FFFF00&
      Caption         =   "2) Stock Critico (Minimo)"
      BeginProperty Font 
         Name            =   "MS Sans Serif"
         Size            =   13.5
         Charset         =   0
...
Private Sub Opcion_Keypress(KeyAscii As Integer)
    ...
    If Val(Chr$(KeyAscii)) = 3 Then
        Menu3.Hide
        Unload Me
        PrgListaFormula.Show
    End If
    If Val(Chr$(KeyAscii)) = 4 Then
        Menu3.Hide
        Unload Me
        PrgListaFormulaCosto.Show
    End If
    If Val(Chr$(KeyAscii)) = 5 Then
        Menu4.Hide
        Unload Me
        PrgListaStockInsumosProve.Show
    End If
    If KeyAscii = 27 Then
        Menu3.Hide
        Unload Me
