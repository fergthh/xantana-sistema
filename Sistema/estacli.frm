...
Begin VB.Form PrgEstacli 
   ...
   Begin VB.Frame Frame2 
      ...
      Begin VB.CommandButton Cancela 
         ...
         Height          =   975
         Left            =   3960
         MouseIcon       =   "estacli.frx":0000
         MousePointer    =   99  'Custom
         Picture         =   "estacli.frx":030A
         Style           =   1  'Graphical
         TabIndex        =   16
         ToolTipText     =   "Salida"
         Top             =   3000
      ...
      Begin VB.CommandButton Impre 
         ...
         Height          =   975
         Left            =   1560
         MouseIcon       =   "estacli.frx":0B4C
         MousePointer    =   99  'Custom
         Picture         =   "estacli.frx":0E56
         Style           =   1  'Graphical
         TabIndex        =   15
      ...
      Begin VB.CommandButton Consulta 
         ...
         Height          =   975
         Left            =   2760
         MouseIcon       =   "estacli.frx":1698
         MousePointer    =   99  'Custom
         Picture         =   "estacli.frx":19A2
         Style           =   1  'Graphical
         TabIndex        =   14
      ...
      Begin VB.CommandButton Panta 
         ...
         Height          =   975
         Left            =   360
         MouseIcon       =   "estacli.frx":21E4
         MousePointer    =   99  'Custom
         Picture         =   "estacli.frx":24EE
         Style           =   1  'Graphical
         TabIndex        =   13
   ...
   Begin VB.ListBox Pantalla 
      ...
      EndProperty
      Height          =   1980
      ItemData        =   "estacli.frx":2D30
      Left            =   840
      List            =   "estacli.frx":2D37
      TabIndex        =   1
      Top             =   4920
      Visible         =   0   'False
      Width           =   6735
...
Private Sub Proceso_Click()
    ...
    Listado.SQLQuery = "SELECT Estadistica.Tipo, Estadistica.Numero, Estadistica.Articulo, Estadistica.Cliente, Estadistica.Fecha, Estadistica.OrdFecha, Estadistica.CantidadII, Estadistica.PrecioII, " _
                + "Cliente.Razon, " _
    ...
    If Tipolist.ListIndex = 0 Then
        ...
        Dos = " and {Estadistica.Cliente} in " + Desde.Text + " to " + Hasta.Text
        
        Listado.GroupSelectionFormula = Uno + Dos
        Listado.SelectionFormula = Uno + Dos
        
        Listado.ReportFileName = "EstaCli.rpt"
        ...
        Listado.ReportFileName = "EstaCli1.rpt"
