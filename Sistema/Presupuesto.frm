...
Begin VB.Form PrgCotiza 
   ...
   Begin VB.Frame PantaNota 
      ...
      Begin VB.CommandButton Cierranota 
         ...
         Height          =   975
         Left            =   3120
         MouseIcon       =   "Presupuesto.frx":0000
         MousePointer    =   99  'Custom
         Picture         =   "Presupuesto.frx":030A
         Style           =   1  'Graphical
         TabIndex        =   66
   ...
   Begin VB.CommandButton Panta 
      ...
      Height          =   975
      Left            =   12840
      MouseIcon       =   "Presupuesto.frx":0B4C
      MousePointer    =   99  'Custom
      Picture         =   "Presupuesto.frx":0E56
      Style           =   1  'Graphical
      TabIndex        =   44
   ...
   Begin VB.CommandButton ImpresionII 
      ...
      Height          =   975
      Left            =   12840
      MouseIcon       =   "Presupuesto.frx":1698
      MousePointer    =   99  'Custom
      Picture         =   "Presupuesto.frx":19A2
      Style           =   1  'Graphical
      TabIndex        =   43
   ...
   Begin VB.CommandButton CmdClose 
      ...
      Height          =   975
      Left            =   13800
      MouseIcon       =   "Presupuesto.frx":21E4
      MousePointer    =   99  'Custom
      Picture         =   "Presupuesto.frx":24EE
      Style           =   1  'Graphical
      TabIndex        =   24
      ToolTipText     =   "Menu Principal"
      Top             =   5880
   ...
   Begin VB.CommandButton Consulta 
      ...
      Height          =   975
      Left            =   11880
      MouseIcon       =   "Presupuesto.frx":2D30
      MousePointer    =   99  'Custom
      Picture         =   "Presupuesto.frx":303A
      Style           =   1  'Graphical
      TabIndex        =   23
   ...
   Begin VB.CommandButton Limpia 
      ...
      Height          =   975
      Left            =   10920
      MouseIcon       =   "Presupuesto.frx":387C
      MousePointer    =   99  'Custom
      Picture         =   "Presupuesto.frx":3B86
      Style           =   1  'Graphical
      TabIndex        =   22
   ...
   Begin VB.CommandButton CmdDelete 
      ...
      Height          =   975
      Left            =   9960
      MouseIcon       =   "Presupuesto.frx":43C8
      MousePointer    =   99  'Custom
      Picture         =   "Presupuesto.frx":46D2
      Style           =   1  'Graphical
      TabIndex        =   21
   ...
   Begin VB.CommandButton Graba 
      ...
      Height          =   975
      Left            =   9000
      MouseIcon       =   "Presupuesto.frx":4F14
      MousePointer    =   99  'Custom
      Picture         =   "Presupuesto.frx":521E
      Style           =   1  'Graphical
      TabIndex        =   20
   ...
   Begin VB.ListBox Pantalla 
      Height          =   1500
      ItemData        =   "Presupuesto.frx":5A60
      Left            =   240
      List            =   "Presupuesto.frx":5A67
      TabIndex        =   2
      Top             =   6240
      Visible         =   0   'False
      Width           =   8655
...
Private Sub Graba_Click()
    ...
    If Val(Numero.Text) <> 0 Then
        ZSql = ""
        ZSql = ZSql + "DELETE Cotiza"
        ZSql = ZSql + " Where Cotiza.Numero = " + "'" + Numero.Text + "'"
        spCotiza = ZSql
        ...
        If rstCotiza.RecordCount > 0 Then
            rstCotiza.MoveLast
            ZUltimo = IIf(IsNull(rstCotiza!NumeroMayor), "0", rstCotiza!NumeroMayor)
...
Private Sub Impresion()
    ...
    Listado.WindowTitle = "Impresion de Cotizaciones"
    Listado.WindowTop = 0
    ...
    Listado.SQLQuery = "SELECT Cotiza.Numero, Cotiza.Renglon, Cotiza.Articulo, Cotiza.Cantidad, Cotiza.Precio, Cotiza.Importe, Cotiza.Cliente, Cotiza.Fecha, Cotiza.Moneda, Cotiza.PrecioII, Cotiza.Dto, Cotiza.ImporteII, Cotiza.Paridad, " _
                ...
                + "Cotiza.Cliente = Cliente.Cliente AND " _
                + "Cotiza.Numero >= " + Numero.Text + " AND " _
                + "Cotiza.Numero <= " + Numero.Text
    
    Listado.Connect = Connect()
    
    Uno = "{Cotiza.Numero} in " + Numero.Text + " to " + Numero.Text
    ...
    Listado.ReportFileName = "ImpreCotiza.rpt"
...
Private Sub Limpia_Click()
    ...
    Rem ZSql = ZSql + " FROM Cotiza"
    Rem spCotiza = ZSql
    Rem Set rstCotiza = db.OpenRecordset(spCotiza, dbOpenSnapshot, dbSQLPassThrough)
    Rem If rstCotiza.RecordCount > 0 Then
    Rem     rstCotiza.MoveLast
    Rem     ZUltimo = IIf(IsNull(rstCotiza!NumeroMayor), "0", rstCotiza!NumeroMayor)
...
Private Sub Proceso_Click()
    ...
    For WRenglon = 1 To 99
        ...
        ZSql = ZSql + "Select *"
        ZSql = ZSql + " FROM Cotiza"
        ZSql = ZSql + " Where Cotiza.Clave = " + "'" + WClave + "'"
        spCotiza = ZSql
        Set rstCotiza = db.OpenRecordset(spCotiza, dbOpenSnapshot, dbSQLPassThrough)
        If rstCotiza.RecordCount > 0 Then
        
            Canti = rstCotiza!Cantidad
            ...
            WVector1.Col = 1
            WVector1.Text = Trim(rstCotiza!articulo)
            Auxi1 = rstCotiza!articulo
                
            WVector1.Col = 3
            WVector1.Text = Pusing("###,###.##", Str$(rstCotiza!Cantidad))
            WWCantidad = rstCotiza!Cantidad
            
            WWPrecio = rstCotiza!Precio
            WWPrecioII = rstCotiza!PrecioII
            
            If rstCotiza!Moneda = 0 Then
                WVector1.Col = 4
                WVector1.Text = "$"
            ...
            WWImporteII = WWPrecioII * WWCantidad
                
            WVector1.Col = 5
            WVector1.Text = Pusing("###,###.##", Str$(rstCotiza!Dto))
            ...
            WVector1.Col = 10
            WVector1.Text = Trim(rstCotiza!FecEntrega)
                
            WVector1.Col = 11
            WVector1.Text = Trim(rstCotiza!observa)
            
            WVector1.Col = 12
            WVector1.Text = Str$(rstCotiza!fabrica)
            
            WVector1.Col = 13
            WVector1.Text = Str$(rstCotiza!facturado)
            
            WVector1.Col = 14
            WVector1.Text = rstCotiza!fechafabrica
            
            WVector1.Col = 15
            WVector1.Text = rstCotiza!Marca
            
            WVector1.Col = 16
            WVector1.Text = rstCotiza!MarcaII
            
            WVector1.Col = 17
            WVector1.Text = Str$(rstCotiza!Entregado)
...
Sub Numero_Keypress(KeyAscii As Integer)
    If KeyAscii = 13 Then
        ...
        If rstCotiza.RecordCount > 0 Then
            ...
            Cliente.Text = rstCotiza!Cliente
            Observaciones.Text = rstCotiza!Observaciones
            
            Observa1.Text = IIf(IsNull(rstCotiza!Observa1), "", rstCotiza!Observa1)
            Observa2.Text = IIf(IsNull(rstCotiza!Observa2), "", rstCotiza!Observa2)
            Observa3.Text = IIf(IsNull(rstCotiza!Observa3), "", rstCotiza!Observa3)
            Observa4.Text = IIf(IsNull(rstCotiza!Observa4), "", rstCotiza!Observa4)
            Observa5.Text = IIf(IsNull(rstCotiza!Observa5), "", rstCotiza!Observa5)
            Observa6.Text = IIf(IsNull(rstCotiza!Observa6), "", rstCotiza!Observa6)
            Observa7.Text = IIf(IsNull(rstCotiza!Observa7), "", rstCotiza!Observa7)
            Observa8.Text = IIf(IsNull(rstCotiza!Observa8), "", rstCotiza!Observa8)
            Observa9.Text = IIf(IsNull(rstCotiza!Observa9), "", rstCotiza!Observa9)
            Observa10.Text = IIf(IsNull(rstCotiza!Observa10), "", rstCotiza!Observa10)
            Observa11.Text = IIf(IsNull(rstCotiza!Observa11), "", rstCotiza!Observa11)
            Observa12.Text = IIf(IsNull(rstCotiza!Observa12), "", rstCotiza!Observa12)
            Observa13.Text = IIf(IsNull(rstCotiza!Observa13), "", rstCotiza!Observa13)
            Observa14.Text = IIf(IsNull(rstCotiza!Observa14), "", rstCotiza!Observa14)
            Observa15.Text = IIf(IsNull(rstCotiza!Observa15), "", rstCotiza!Observa15)
            Observa16.Text = IIf(IsNull(rstCotiza!Observa16), "", rstCotiza!Observa16)
            Observa17.Text = IIf(IsNull(rstCotiza!Observa17), "", rstCotiza!Observa17)
            Observa18.Text = IIf(IsNull(rstCotiza!Observa18), "", rstCotiza!Observa18)
            Observa19.Text = IIf(IsNull(rstCotiza!Observa19), "", rstCotiza!Observa19)
            Observa20.Text = IIf(IsNull(rstCotiza!Observa20), "", rstCotiza!Observa20)
