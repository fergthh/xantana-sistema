...
Begin VB.Form PrgValcarCliente 
   AutoRedraw      =   -1  'True
   Caption         =   "Listado de Cheques por Cliente"
   ClientHeight    =   7350
   ClientLeft      =   3210
   ClientTop       =   720
   ClientWidth     =   6030
   ...
   Begin VB.ListBox Pantalla 
      ...
      EndProperty
      Height          =   2790
      ItemData        =   "valcarcliente.frx":0000
      Left            =   240
      List            =   "valcarcliente.frx":0007
      TabIndex        =   16
      Top             =   4440
      Visible         =   0   'False
      Width           =   5295
   ...
   Begin VB.Frame Frame2 
      ...
      Begin VB.CommandButton Consulta 
         ...
         Height          =   975
         Left            =   1440
         MouseIcon       =   "valcarcliente.frx":0015
         MousePointer    =   99  'Custom
         Picture         =   "valcarcliente.frx":031F
         Style           =   1  'Graphical
         TabIndex        =   13
      ...
      Begin VB.CommandButton Panta 
         ...
         Height          =   975
         Left            =   240
         MouseIcon       =   "valcarcliente.frx":0B61
         MousePointer    =   99  'Custom
         Picture         =   "valcarcliente.frx":0E6B
         Style           =   1  'Graphical
         TabIndex        =   9
      ...
      Begin VB.CommandButton Impre 
         ...
         Height          =   975
         Left            =   2760
         MouseIcon       =   "valcarcliente.frx":16AD
         MousePointer    =   99  'Custom
         Picture         =   "valcarcliente.frx":19B7
         Style           =   1  'Graphical
         TabIndex        =   8
      ...
      Begin VB.CommandButton Cancela 
         ...
         Height          =   975
         Left            =   4080
         MouseIcon       =   "valcarcliente.frx":21F9
         MousePointer    =   99  'Custom
         Picture         =   "valcarcliente.frx":2503
         Style           =   1  'Graphical
         TabIndex        =   7
         ToolTipText     =   "Salida"
         Top             =   2760
   ...
   Begin Crystal.CrystalReport Listado 
      ...
      _ExtentY        =   741
      _Version        =   262150
      ReportFileName  =   "carteraCliente.rpt"
      Destination     =   1
   ...
   End
End
Attribute VB_Name = "PrgValcarCliente"
...
Private Sub Proceso_Click()
    ...
    ZSql = ZSql + " Where ProveedorSalida is null"
    spRecibos = ZSql
    Set rstRecibos = db.OpenRecordset(spRecibos, dbOpenSnapshot, dbSQLPassThrough)
    ...
    Listado.SQLQuery = "SELECT Recibos.Recibo, Recibos.Cliente, Recibos.TipoReg, Recibos.Tipo2, Recibos.Numero2, Recibos.Fecha2, Recibos.banco2, Recibos.Importe2, Recibos.Estado2, Recibos.FechaOrd2, Recibos.Orden, Recibos.Deposito, Recibos.SucursalCheque, Recibos.TipoCheque, Recibos.ClaseCheque, Recibos.ProveedorSalida, Recibos.BancoSalida, Recibos.Periodo,  " _
            + "Auxiliar.Nombre, Auxiliar.Actividad, Auxiliar.Varios, Cliente.Razon, Proveedor.Nombre, Banco.Nombre " _
            + "From " _
    ...
    Cuatro = " and {Recibos.cliente} in " + Chr$(34) + Desde.Text + Chr$(34) + " to " + Chr$(34) + Hasta.Text + Chr$(34)
...
Private Sub Desde_Keypress(KeyAscii As Integer)
    If KeyAscii = 13 Then
        If Desde.Text <> "" Then
            ...
            ZSql = ZSql + " Where Cliente.Cliente = " + "'" + Desde.Text + "'"
            spCliente = ZSql
