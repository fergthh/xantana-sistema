...
Begin VB.Form Menu231 
   ...
   EndProperty
   Icon            =   "menu231.frx":0000
   LinkTopic       =   "Form1"
   MouseIcon       =   "menu231.frx":0442
   ScaleHeight     =   8310
   ScaleWidth      =   11640
   ...
   Begin VB.Label Label10 
      Alignment       =   2  'Center
      BackColor       =   &H00FFFF00&
      Caption         =   "8) Listado de Stock Exedido"
      BeginProperty Font 
         Name            =   "MS Sans Serif"
         Size            =   13.5
         Charset         =   0
   ...
   Begin VB.Label Label9 
      Alignment       =   2  'Center
      BackColor       =   &H00FFFF00&
      Caption         =   "7) Valorizacion de Stock (a fecha)"
      BeginProperty Font 
         Name            =   "MS Sans Serif"
         Size            =   13.5
         Charset         =   0
   ...
   Begin VB.Label Label8 
      Alignment       =   2  'Center
      BackColor       =   &H00FFFF00&
      Caption         =   "6) Listado de Ordenes de Importacion "
      BeginProperty Font 
         Name            =   "MS Sans Serif"
         Size            =   13.5
         Charset         =   0
   ...
   Begin VB.Label Label6 
      Alignment       =   2  'Center
      BackColor       =   &H00FFFF00&
      Caption         =   "5) Movimientos de Stock"
      BeginProperty Font 
         Name            =   "MS Sans Serif"
         Size            =   13.5
         Charset         =   0
   ...
   Begin VB.Label Label5 
      Alignment       =   2  'Center
      BackColor       =   &H00FFFF00&
      Caption         =   "4) Valorizacion de Stock"
      BeginProperty Font 
         Name            =   "MS Sans Serif"
         Size            =   13.5
         Charset         =   0
   ...
   Begin VB.Label Label4 
      Alignment       =   2  'Center
      BackColor       =   &H00FFFF00&
      Caption         =   "3) Pedido de Reposicion"
      BeginProperty Font 
         Name            =   "MS Sans Serif"
         Size            =   13.5
         Charset         =   0
   ...
   Begin VB.Label Label1 
      Alignment       =   2  'Center
      Caption         =   "LISTADOS DE MANEJO DE STOCK"
      BeginProperty Font 
         Name            =   "MS Sans Serif"
         Size            =   13.5
         Charset         =   0
...
Private Sub Opcion_Keypress(KeyAscii As Integer)
    ...
    If Val(Chr$(KeyAscii)) = 6 Then
        Menu231.Hide
        Unload Me
        PrgListaOrdenImportacion.Show
    End If
    If Val(Chr$(KeyAscii)) = 7 Then
        Menu231.Hide
        Unload Me
        PrgListaStockValoraFecha.Show
    End If
    If Val(Chr$(KeyAscii)) = 8 Then
        Menu231.Hide
        Unload Me
        PrgEstaGrupoStock.Show
    End If
    If KeyAscii = 27 Then
        Menu231.Hide
        Unload Me
