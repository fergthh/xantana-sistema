...
Begin VB.Form PrgMixVentas 
   AutoRedraw      =   -1  'True
   Caption         =   "Mix de Ventas"
   ClientHeight    =   3390
   ClientLeft      =   1890
   ClientTop       =   1080
   ClientWidth     =   8145
   ...
   Begin VB.Frame Frame2 
      ...
      Begin VB.CommandButton Cancela 
         ...
         Height          =   975
         Left            =   3960
         MouseIcon       =   "MixVentas.frx":0000
         MousePointer    =   99  'Custom
         Picture         =   "MixVentas.frx":030A
         Style           =   1  'Graphical
         TabIndex        =   4
         ToolTipText     =   "Salida"
         Top             =   1560
      ...
      Begin VB.CommandButton Impre 
         ...
         Height          =   975
         Left            =   2160
         MouseIcon       =   "MixVentas.frx":0B4C
         MousePointer    =   99  'Custom
         Picture         =   "MixVentas.frx":0E56
         Style           =   1  'Graphical
         TabIndex        =   3
      ...
      Begin VB.CommandButton Panta 
         ...
         Height          =   975
         Left            =   360
         MouseIcon       =   "MixVentas.frx":1698
         MousePointer    =   99  'Custom
         Picture         =   "MixVentas.frx":19A2
         Style           =   1  'Graphical
         TabIndex        =   2
   ...
   End
End
Attribute VB_Name = "PrgMixVentas"
...
Private Sub Proceso_Click()
    ...
    ZSql = ZSql + " Estadistica.CodigoEmpresa = " + "'" + WEmpresa + "',"
    ZSql = ZSql + " Estadistica.TipoIII = 1"
    ZSql = ZSql + " From Estadistica"
    ZSql = ZSql + " Where Estadistica.OrdFecha >= " + "'" + WDesde + "'"
    ZSql = ZSql + " and Estadistica.OrdFecha <= " + "'" + WHasta + "'"
    ZSql = ZSql + " and Estadistica.Articulo >= " + "'" + "A00000" + "'"
    ZSql = ZSql + " and Estadistica.Articulo < " + "'" + "Z00000" + "'"
    spEstadistica = ZSql
    ...
    ZSql = ZSql + "UPDATE Estadistica SET "
    ZSql = ZSql + " Estadistica.CodigoEmpresa = " + "'" + WEmpresa + "',"
    ZSql = ZSql + " Estadistica.TipoIII = 2"
    ZSql = ZSql + " From Estadistica"
    ZSql = ZSql + " Where Estadistica.OrdFecha >= " + "'" + WDesde + "'"
    ZSql = ZSql + " and Estadistica.OrdFecha <= " + "'" + WHasta + "'"
    ZSql = ZSql + " and Estadistica.Articulo >= " + "'" + "Z00000" + "'"
    ...
    Listado.WindowTitle = "Mix de Ventas"
    Listado.WindowTop = 0
    Listado.WindowLeft = 0
    Listado.WindowWidth = Screen.Width
    Listado.WindowHeight = Screen.Height
    
    Listado.SQLQuery = "SELECT Estadistica.Cantidad, Estadistica.Precio, Estadistica.OrdFecha, Estadistica.Descuento, Estadistica.TipoIII, " _
            + "Auxiliar.Varios " _
            + "From " _
            ...
            + "Estadistica.TipoIII >= 1 AND " _
            + "Estadistica.TipoIII <= 2"
    
    DbConnect = db.Connect
    DSQ = getDatabase(DbConnect)
            
    Uno = "{Estadistica.OrdFecha} in " + Chr$(34) + WDesde + Chr$(34) + " to " + Chr$(34) + WHasta + Chr$(34)
    Dos = " and {Estadistica.TipoIII} in " + "1" + " to " + "2"
    
    Listado.GroupSelectionFormula = Uno + Dos
    Listado.SelectionFormula = Uno + Dos
    
    Listado.ReportFileName = "MixVentas.rpt"
