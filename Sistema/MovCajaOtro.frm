...
Begin VB.Form PrgMovCajaOtro 
   ...
   Begin VB.Frame Frame2 
      ...
      Begin VB.CommandButton Panta 
         ...
         Height          =   975
         Left            =   600
         MouseIcon       =   "MovCajaOtro.frx":0000
         MousePointer    =   99  'Custom
         Picture         =   "MovCajaOtro.frx":030A
         Style           =   1  'Graphical
         TabIndex        =   8
      ...
      Begin VB.CommandButton Impre 
         ...
         Height          =   975
         Left            =   1920
         MouseIcon       =   "MovCajaOtro.frx":0B4C
         MousePointer    =   99  'Custom
         Picture         =   "MovCajaOtro.frx":0E56
         Style           =   1  'Graphical
         TabIndex        =   7
      ...
      Begin VB.CommandButton Cancela 
         ...
         Height          =   975
         Left            =   3240
         MouseIcon       =   "MovCajaOtro.frx":1698
         MousePointer    =   99  'Custom
         Picture         =   "MovCajaOtro.frx":19A2
         Style           =   1  'Graphical
         TabIndex        =   6
         ToolTipText     =   "Salida"
         Top             =   1440
...
Dim ZVectorIII(10000, 25) As String

Dim ZLugar As Integer
Dim ZLugarII As Integer
Dim ZLugarIII As Integer
...
Private Sub Proceso_Click()
        ...
        With rstTransferencia
            ...
            Do
                ...
                If WDesde <= rstTransferencia!ordfecha Then
                    ...
                    ZVectorIII(ZLugarIII, 1) = Str$(rstTransferencia!Codigo)
                    ZVectorIII(ZLugarIII, 2) = rstTransferencia!Fecha
                    ZVectorIII(ZLugarIII, 3) = rstTransferencia!BancoI
                    ZVectorIII(ZLugarIII, 4) = Str$(rstTransferencia!Importe)
                    ZVectorIII(ZLugarIII, 5) = rstTransferencia!ordfecha
                    ZVectorIII(ZLugarIII, 6) = rstTransferencia!Observaciones
                    ZVectorIII(ZLugarIII, 7) = Str$(rstTransferencia!TipoI)
                    ZVectorIII(ZLugarIII, 8) = "1"
        ...
        With rstTransferencia
            ...
            Do
                ...
                If WDesde <= rstTransferencia!ordfecha Then
                    ...
                    ZVectorIII(ZLugarIII, 1) = Str$(rstTransferencia!Codigo)
                    ZVectorIII(ZLugarIII, 2) = rstTransferencia!Fecha
                    ZVectorIII(ZLugarIII, 3) = rstTransferencia!BancoII
                    ZVectorIII(ZLugarIII, 4) = Str$(rstTransferencia!Importe)
                    ZVectorIII(ZLugarIII, 5) = rstTransferencia!ordfecha
                    ZVectorIII(ZLugarIII, 6) = rstTransferencia!Observaciones
                    ZVectorIII(ZLugarIII, 7) = Str$(rstTransferencia!TipoII)
                    ZVectorIII(ZLugarIII, 8) = "2"
    ...
    If rstGastosCaja.RecordCount > 0 Then
        With rstGastosCaja
            ...
            Do
                ...
                If WDesde > WFechaOrd Then
                    WInicial = WInicial - rstGastosCaja!Importe
                End If
    ...
    For Ciclo = 1 To ZLugarIII
    
        ZOrden = ZOrden + 1
        WWOrden = Str$(ZOrden)
        WCodigo = ZVectorIII(Ciclo, 1)
        WFecha = ZVectorIII(Ciclo, 2)
        WBanco = ZVectorIII(Ciclo, 3)
        WImporte = ZVectorIII(Ciclo, 4)
        WOrdFecha = ZVectorIII(Ciclo, 5)
        WObservaciones = ZVectorIII(Ciclo, 6)
        WTipo = ZVectorIII(Ciclo, 7)
        WTipoII = ZVectorIII(Ciclo, 8)
        WComprobante = ""
