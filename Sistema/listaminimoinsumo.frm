...
Begin VB.Form PrgListaMinimoInsumos 
   AutoRedraw      =   -1  'True
   ...
   Begin VB.Frame Frame2 
      ...
      Begin VB.CommandButton Cancela 
         ...
         Height          =   975
         Left            =   4440
         MouseIcon       =   "listaminimoinsumo.frx":0000
         MousePointer    =   99  'Custom
         Picture         =   "listaminimoinsumo.frx":030A
         Style           =   1  'Graphical
         TabIndex        =   7
         ToolTipText     =   "Salida"
         Top             =   1920
      ...
      Begin VB.CommandButton Impre 
         ...
         Height          =   975
         Left            =   2640
         MouseIcon       =   "listaminimoinsumo.frx":0B4C
         MousePointer    =   99  'Custom
         Picture         =   "listaminimoinsumo.frx":0E56
         Style           =   1  'Graphical
         TabIndex        =   6
      ...
      Begin VB.CommandButton Panta 
         ...
         Height          =   975
         Left            =   720
         MouseIcon       =   "listaminimoinsumo.frx":1698
         MousePointer    =   99  'Custom
         Picture         =   "listaminimoinsumo.frx":19A2
         Style           =   1  'Graphical
         TabIndex        =   5
   ...
   End
End
Attribute VB_Name = "PrgListaMinimoInsumos"
...
Private Sub Proceso_Click()
    ...
    Listado.SQLQuery = "SELECT Insumo.Codigo, Insumo.Descripcion, Insumo.Linea, Insumo.Stock, Insumo.StockI, Insumo.StockII, Insumo.StockIII, Insumo.StockIV, Insumo.StockV, Insumo.StockVI " _
            + "From " _
    ...
    Listado.ReportFileName = "Insumos.rpt"
