...
Begin VB.Form PrgCompArt 
   ...
   Begin VB.CommandButton CmdClose 
      ...
      Height          =   975
      Left            =   8760
      MouseIcon       =   "compart.frx":0000
      MousePointer    =   99  'Custom
      Picture         =   "compart.frx":030A
      Style           =   1  'Graphical
      TabIndex        =   19
   ...
   Begin VB.CommandButton Consulta 
      ...
      Height          =   975
      Left            =   8760
      MouseIcon       =   "compart.frx":0B4C
      MousePointer    =   99  'Custom
      Picture         =   "compart.frx":0E56
      Style           =   1  'Graphical
      TabIndex        =   23
   ...
   Begin VB.CommandButton Limpia 
      ...
      Height          =   975
      Left            =   8760
      MouseIcon       =   "compart.frx":1698
      MousePointer    =   99  'Custom
      Picture         =   "compart.frx":19A2
      Style           =   1  'Graphical
      TabIndex        =   22
   ...
   Begin VB.CommandButton CmdDelete 
      ...
      Height          =   975
      Left            =   8760
      MouseIcon       =   "compart.frx":21E4
      MousePointer    =   99  'Custom
      Picture         =   "compart.frx":24EE
      Style           =   1  'Graphical
      TabIndex        =   21
   ...
   Begin VB.CommandButton Graba 
      ...
      Height          =   975
      Left            =   8760
      MouseIcon       =   "compart.frx":2D30
      MousePointer    =   99  'Custom
      Picture         =   "compart.frx":303A
      Style           =   1  'Graphical
      TabIndex        =   20
   ...
   Begin VB.ListBox Pantalla 
      ...
      EndProperty
      Height          =   1740
      ItemData        =   "compart.frx":387C
      Left            =   120
      List            =   "compart.frx":3883
      TabIndex        =   1
      Top             =   6240
      Visible         =   0   'False
      Width           =   6855
...
Private Sub Graba_Click()
    ...
    ZSql = ZSql + " Where Compras.Numero = " + "'" + Numero.Text + "'"
    spCompras = ZSql
    Set rstCompras = db.OpenRecordset(spCompras, dbOpenSnapshot, dbSQLPassThrough)
    ...
    For iRow = 1 To 100
        ...
        If Cantidad <> 0 Then
            ...
            If Val(ZZCosto) <> 0 Then
                ZSql = ""
                ZSql = ZSql + "UPDATE Articulo SET "
                ZSql = ZSql + " Costo = " + "'" + ZZCosto + "'"
                ZSql = ZSql + " Where Codigo = " + "'" + ZZArticulo + "'"
                spArticulo = ZSql
                Set rstArticulo = db.OpenRecordset(spArticulo, dbOpenSnapshot, dbSQLPassThrough)
            End If
...
Private Sub Proceso_Click()
    ...
    For WRenglon = 1 To 100
        ...
        If rstCompras.RecordCount > 0 Then
            ...
            WVector1.Col = 1
            WVector1.Text = rstCompras!Articulo
            Auxi1 = rstCompras!Articulo
                
            WVector1.Col = 3
            WVector1.Text = Pusing("###,###", Str$(rstCompras!Cantidad))
                
            WVector1.Col = 4
            WVector1.Text = Pusing("###,###.##", Str$(rstCompras!Costo))
...
Private Sub Numero_KeyPress(KeyAscii As Integer)
    If KeyAscii = 13 Then
        ...
        ZSql = ZSql + "Select *"
        ZSql = ZSql + " FROM Compras"
        ZSql = ZSql + " Where Compras.Numero = " + "'" + Auxi + "'"
        spCompras = ZSql
        Set rstCompras = db.OpenRecordset(spCompras, dbOpenSnapshot, dbSQLPassThrough)
        If rstCompras.RecordCount > 0 Then
            
            Fecha.Text = rstCompras!Fecha
            Observaciones.Text = rstCompras!Observaciones
            rstCompras.Close
