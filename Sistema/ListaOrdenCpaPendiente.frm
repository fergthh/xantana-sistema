...
Begin VB.Form PrgListaOrdenCpaPendiente 
   AutoRedraw      =   -1  'True
   ...
   Begin VB.Frame Frame2 
      ...
      Begin VB.CommandButton Cancela 
         ...
         Height          =   975
         Left            =   3840
         MouseIcon       =   "ListaOrdenCpaPendiente.frx":0000
         MousePointer    =   99  'Custom
         Picture         =   "ListaOrdenCpaPendiente.frx":030A
         Style           =   1  'Graphical
         TabIndex        =   10
         ToolTipText     =   "Salida"
         Top             =   2160
      ...
      Begin VB.CommandButton Impre 
         ...
         Height          =   975
         Left            =   2040
         MouseIcon       =   "ListaOrdenCpaPendiente.frx":0B4C
         MousePointer    =   99  'Custom
         Picture         =   "ListaOrdenCpaPendiente.frx":0E56
         Style           =   1  'Graphical
         TabIndex        =   9
      ...
      Begin VB.CommandButton Panta 
         ...
         Height          =   975
         Left            =   240
         MouseIcon       =   "ListaOrdenCpaPendiente.frx":1698
         MousePointer    =   99  'Custom
         Picture         =   "ListaOrdenCpaPendiente.frx":19A2
         Style           =   1  'Graphical
         TabIndex        =   8
   ...
   End
End
Attribute VB_Name = "PrgListaOrdenCpaPendiente"
...
Private Sub Proceso_Click()
    ...
    ZSql = ZSql + " Saldo = Cantidad - Pedida - Ajuste"
    spOrden = ZSql
    ...
    If Tipo.ListIndex = 0 Then
        ...
        Listado.SQLQuery = "SELECT Orden.Numero, Orden.Renglon, Orden.Proveedor, Orden.Fecha, Orden.OrdFecha, Orden.Insumo, Orden.Cantidad, Orden.Pedida, Orden.Saldo, " _
                + "Proveedor.Nombre, " _
                ...
                + "Orden.OrdFecha >= '" + WDesde + "' AND " _
                + "Orden.OrdFecha <= '" + WHasta + "' AND " _
                + "Orden.Saldo > 0"
                
        Listado.Connect = Connect()
    
        Uno = "{Orden.OrdFecha} in " + Chr$(34) + WDesde + Chr$(34) + " to " + Chr$(34) + WHasta + Chr$(34)
        
        Listado.GroupSelectionFormula = Uno
        Listado.SelectionFormula = Uno
        
        Listado.ReportFileName = "ListaOrdenCpapend.rpt"
        ...
        Listado.ReportFileName = "ListaOrdenCpa.rpt"
...
Private Sub Cancela_click()
    PrgListaOrdenCpaPendiente.Hide
    Unload Me
    MenuVen.Show
End Sub
