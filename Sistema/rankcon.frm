...
Begin VB.Form PrgRankCon 
   AutoRedraw      =   -1  'True
   Caption         =   "Listado de Ranking de Compras por Concepto"
   ClientHeight    =   6615
   ClientLeft      =   3165
   ClientTop       =   1200
   ClientWidth     =   5655
   ...
   Begin VB.Frame Frame2 
      ...
      Begin VB.CommandButton Consulta 
         ...
         Height          =   975
         Left            =   2880
         MouseIcon       =   "rankcon.frx":0000
         MousePointer    =   99  'Custom
         Picture         =   "rankcon.frx":030A
         Style           =   1  'Graphical
         TabIndex        =   15
      ...
      Begin VB.CommandButton Panta 
         ...
         Height          =   975
         Left            =   240
         MouseIcon       =   "rankcon.frx":0B4C
         MousePointer    =   99  'Custom
         Picture         =   "rankcon.frx":0E56
         Style           =   1  'Graphical
         TabIndex        =   14
      ...
      Begin VB.CommandButton Impre 
         ...
         Height          =   975
         Left            =   1560
         MouseIcon       =   "rankcon.frx":1698
         MousePointer    =   99  'Custom
         Picture         =   "rankcon.frx":19A2
         Style           =   1  'Graphical
         TabIndex        =   13
      ...
      Begin VB.CommandButton Cancela 
         ...
         Height          =   975
         Left            =   4200
         MouseIcon       =   "rankcon.frx":21E4
         MousePointer    =   99  'Custom
         Picture         =   "rankcon.frx":24EE
         Style           =   1  'Graphical
         TabIndex        =   12
         ToolTipText     =   "Salida"
         Top             =   2280
   ...
   Begin VB.ListBox Pantalla 
      ...
      EndProperty
      Height          =   2400
      ItemData        =   "rankcon.frx":2D30
      Left            =   120
      List            =   "rankcon.frx":2D37
      TabIndex        =   2
      Top             =   4200
      Visible         =   0   'False
      Width           =   5415
...
Private Sub Proceso_Click()
    ...
    Listado.WindowTitle = "Listado de Ranking de Compras por Concepto"
    Listado.WindowTop = 0
    ...
    Listado.SQLQuery = "SELECT IvaComp.Proveedor, IvaComp.Neto, IvaComp.Exento, IvaComp.Ordfecha, " _
                + "Proveedor.Nombre, " _
    ...
    Uno = "{IvaComp.Concepto} in " + Desdecon.Text + " to " + Hastacon.Text
    Dos = " and {IvaComp.Ordfecha} in " + Chr$(34) + WDesde + Chr$(34) + " to " + Chr$(34) + WHasta + Chr$(34)
...
Private Sub Pantalla_Click()
    ...
    Desdecon.Text = WIndice.List(Indice)
    Hastacon.Text = WIndice.List(Indice)
    Desdecon.SetFocus
End Sub
