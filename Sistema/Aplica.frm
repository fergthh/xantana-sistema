...
Begin VB.Form PrgAplica 
   ...
   Begin VB.CommandButton CmdClose 
      ...
      Height          =   975
      Left            =   10920
      MouseIcon       =   "Aplica.frx":0000
      MousePointer    =   99  'Custom
      Picture         =   "Aplica.frx":030A
      Style           =   1  'Graphical
      TabIndex        =   41
   ...
   Begin VB.CommandButton Consulta 
      ...
      Height          =   975
      Left            =   10920
      MouseIcon       =   "Aplica.frx":0B4C
      MousePointer    =   99  'Custom
      Picture         =   "Aplica.frx":0E56
      Style           =   1  'Graphical
      TabIndex        =   40
   ...
   Begin VB.CommandButton CmdLimpiar 
      ...
      Height          =   975
      Left            =   10920
      MouseIcon       =   "Aplica.frx":1698
      MousePointer    =   99  'Custom
      Picture         =   "Aplica.frx":19A2
      Style           =   1  'Graphical
      TabIndex        =   39
   ...
   Begin VB.CommandButton CmdDelete 
      ...
      Height          =   975
      Left            =   10920
      MouseIcon       =   "Aplica.frx":21E4
      MousePointer    =   99  'Custom
      Picture         =   "Aplica.frx":24EE
      Style           =   1  'Graphical
      TabIndex        =   38
   ...
   Begin VB.CommandButton CmdAdd 
      ...
      Height          =   975
      Left            =   10920
      MouseIcon       =   "Aplica.frx":2D30
      MousePointer    =   99  'Custom
      Picture         =   "Aplica.frx":303A
      Style           =   1  'Graphical
      TabIndex        =   37
   ...
   Begin VB.CommandButton Ctacte 
      ...
      Height          =   975
      Left            =   10920
      MouseIcon       =   "Aplica.frx":387C
      MousePointer    =   99  'Custom
      Picture         =   "Aplica.frx":3B86
      Style           =   1  'Graphical
      TabIndex        =   36
   ...
   Begin VB.ListBox Pantalla 
      ...
      EndProperty
      Height          =   2205
      ItemData        =   "Aplica.frx":4450
      Left            =   6720
      List            =   "Aplica.frx":4457
      TabIndex        =   6
      Top             =   480
      Visible         =   0   'False
      Width           =   4095
...
Private Sub Suma_Datos()
    ...
    Debitos.Caption = Str$(ZDebito - ZRetencion - ZDescuento)
    Debitos.Caption = Alinea("###,###.##", Debitos.Caption)
    
    Diferencia.Caption = Str$(ZImpoRecibo - ZRetencion - ZImpoDtoRecibo)
...
Private Sub cmdAdd_Click()
    ...
    Call Suma_Datos
    If Abs(Val(Debitos.Caption)) > 1 Then
        Exit Sub
    End If
    ...
    If Respuesta% = 6 Then
        ...
        For Ciclo = 1 To 9
            ...
            If Val(WVector1.TextMatrix(Ciclo, 1)) <> 0 Then
                ...
                Print #99, Tab(16); Impre;
                Impre = Pusing("###,###,###.##", WVector1.TextMatrix(Ciclo, 5))
                Print #99, Tab(24); Impre;
