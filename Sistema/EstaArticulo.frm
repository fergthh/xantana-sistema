...
Begin VB.Form PrgEstaArticulo 
   ...
   Begin VB.Frame Frame2 
      ...
      Begin VB.CommandButton Cancela 
         ...
         Height          =   975
         Left            =   3960
         MouseIcon       =   "EstaArticulo.frx":0000
         MousePointer    =   99  'Custom
         Picture         =   "EstaArticulo.frx":030A
         Style           =   1  'Graphical
         TabIndex        =   7
         ToolTipText     =   "Salida"
         Top             =   3000
      ...
      Begin VB.CommandButton Impre 
         ...
         Height          =   975
         Left            =   1560
         MouseIcon       =   "EstaArticulo.frx":0B4C
         MousePointer    =   99  'Custom
         Picture         =   "EstaArticulo.frx":0E56
         Style           =   1  'Graphical
         TabIndex        =   5
      ...
      Begin VB.CommandButton Consulta 
         ...
         Height          =   975
         Left            =   2760
         MouseIcon       =   "EstaArticulo.frx":1698
         MousePointer    =   99  'Custom
         Picture         =   "EstaArticulo.frx":19A2
         Style           =   1  'Graphical
         TabIndex        =   6
      ...
      Begin VB.CommandButton Panta 
         ...
         Height          =   975
         Left            =   360
         MouseIcon       =   "EstaArticulo.frx":21E4
         MousePointer    =   99  'Custom
         Picture         =   "EstaArticulo.frx":24EE
         Style           =   1  'Graphical
         TabIndex        =   4
   ...
   Begin VB.ListBox Pantalla 
      ...
      EndProperty
      Height          =   1980
      ItemData        =   "EstaArticulo.frx":2D30
      Left            =   840
      List            =   "EstaArticulo.frx":2D37
      TabIndex        =   8
      Top             =   4920
      Visible         =   0   'False
      Width           =   6735
   End
End
Attribute VB_Name = "PrgEstaArticulo"
...
Private Sub Proceso_Click()
    ...
    Listado.WindowTitle = "Estadistica de Ventas por Articulo"
    Listado.WindowTop = 0
    ...
    Listado.SQLQuery = "SELECT Estadistica.Numero, Estadistica.Articulo, Estadistica.Cantidad, Estadistica.Precio, Estadistica.Cliente, Estadistica.Fecha, Estadistica.OrdFecha, Estadistica.Descuento, Estadistica.CantidadII, " _
            + "Articulo.Descripcion, Articulo.Costo, " _
    ...
    Listado.ReportFileName = "EstaArticulo.rpt"
