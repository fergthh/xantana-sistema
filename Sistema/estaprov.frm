...
Begin VB.Form PrgEstaProv 
   AutoRedraw      =   -1  'True
   Caption         =   "Estadistica de Ventas por Proveedor"
   ClientHeight    =   7020
   ClientLeft      =   1890
   ClientTop       =   1080
   ClientWidth     =   8145
   ...
   Begin VB.Frame Frame2 
      ...
      Begin VB.CommandButton Cancela 
         ...
         Height          =   975
         Left            =   3960
         MouseIcon       =   "estaprov.frx":0000
         MousePointer    =   99  'Custom
         Picture         =   "estaprov.frx":030A
         Style           =   1  'Graphical
         TabIndex        =   16
         ToolTipText     =   "Salida"
         Top             =   3000
      ...
      Begin VB.CommandButton Impre 
         ...
         Height          =   975
         Left            =   1560
         MouseIcon       =   "estaprov.frx":0B4C
         MousePointer    =   99  'Custom
         Picture         =   "estaprov.frx":0E56
         Style           =   1  'Graphical
         TabIndex        =   15
      ...
      Begin VB.CommandButton Consulta 
         ...
         Height          =   975
         Left            =   2760
         MouseIcon       =   "estaprov.frx":1698
         MousePointer    =   99  'Custom
         Picture         =   "estaprov.frx":19A2
         Style           =   1  'Graphical
         TabIndex        =   14
      ...
      Begin VB.CommandButton Panta 
         ...
         Height          =   975
         Left            =   360
         MouseIcon       =   "estaprov.frx":21E4
         MousePointer    =   99  'Custom
         Picture         =   "estaprov.frx":24EE
         Style           =   1  'Graphical
         TabIndex        =   13
   ...
   Begin VB.ListBox Pantalla 
      ...
      EndProperty
      Height          =   1980
      ItemData        =   "estaprov.frx":2D30
      Left            =   840
      List            =   "estaprov.frx":2D37
      TabIndex        =   1
      Top             =   4920
      Visible         =   0   'False
      Width           =   6735
...
Private Sub Proceso_Click()
    ...
    ZSql = ""
    ZSql = ZSql + "Select *, Articulo.Proveedor as [WProveedor]"
    ...
    If rstEstadistica.RecordCount > 0 Then
        With rstEstadistica
            ...
            Do
                If .EOF = False Then
                    WProve = rstEstadistica!WProveedor
                    Rem If WProve = 302 Then Stop
                    If Tipolist.ListIndex = 0 Then
                        ...
                        WImpo(WProve) = WImpo(WProve) + ZNeto
                        ZTotal = ZTotal + ZNeto
                        
                            Else
                            
                        WImpo(WProve) = WImpo(WProve) + rstEstadistica!Cantidad
    ...
    For Ciclo = 0 To 1000
        ...
        If WImpo(Ciclo) <> 0 Then
            ...
            ZSql = ZSql + " Where Proveedor = " + "'" + Str$(Ciclo) + "'"
            spProveedor = ZSql
    ...
    Listado.WindowTitle = "Estadistica de Ventas por Proveedor"
    Listado.WindowTop = 0
    ...
    Listado.SQLQuery = "SELECT Estadistica.Tipo, Estadistica.Numero, Estadistica.Cantidad, Estadistica.Precio, Estadistica.Fecha, Estadistica.OrdFecha, Estadistica.Descuento, Estadistica.CantidadII, " _
            + "Articulo.Proveedor, Articulo.Costo, " _
            + "Auxiliar.Nombre, Auxiliar.Varios, " _
            + "Proveedor.Nombre, Proveedor.Ordena" _
            + "From " _
    ...
    Select Case Tipolist.ListIndex
        Case 0, 1
            Listado.ReportFileName = "Estaprov.rpt"
        Case 2
            Listado.ReportFileName = "Estaprovarti.rpt"
        Case Else
            Listado.SQLQuery = "SELECT Estadistica.Tipo, Estadistica.Numero, Estadistica.Articulo, Estadistica.Cantidad, Estadistica.Precio, Estadistica.Cliente, Estadistica.Fecha, Estadistica.OrdFecha, Estadistica.Descuento, Estadistica.CantidadII, " _
                + "Articulo.Proveedor, Articulo.Costo, " _
                + "Auxiliar.Nombre, Auxiliar.Varios, " _
                + "Cliente.Razon, " _
                + "Proveedor.Nombre, Proveedor.Ordena " _
            ...
            Listado.ReportFileName = "EstaprovClie.rpt"
    End Select
