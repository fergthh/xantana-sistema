...
Begin VB.Form PrgListOrdenImpoPend 
   AutoRedraw      =   -1  'True
   ...
   Begin VB.Frame Frame2 
      ...
      Begin VB.CommandButton Panta 
         ...
         Height          =   975
         Left            =   600
         MouseIcon       =   "listordenimpoPend.frx":0000
         MousePointer    =   99  'Custom
         Picture         =   "listordenimpoPend.frx":030A
         Style           =   1  'Graphical
         TabIndex        =   11
      ...
      Begin VB.CommandButton Impre 
         ...
         Height          =   975
         Left            =   2040
         MouseIcon       =   "listordenimpoPend.frx":0B4C
         MousePointer    =   99  'Custom
         Picture         =   "listordenimpoPend.frx":0E56
         Style           =   1  'Graphical
         TabIndex        =   10
      ...
      Begin VB.CommandButton Cancela 
         ...
         Height          =   975
         Left            =   3360
         MouseIcon       =   "listordenimpoPend.frx":1698
         MousePointer    =   99  'Custom
         Picture         =   "listordenimpoPend.frx":19A2
         Style           =   1  'Graphical
         TabIndex        =   9
         ToolTipText     =   "Salida"
         Top             =   2520
   ...
   Begin Crystal.CrystalReport Listado 
      ...
      _ExtentY        =   741
      _Version        =   262150
      ReportFileName  =   "ListOrdenImpoPend.rpt"
      Destination     =   1
   ...
   End
End
Attribute VB_Name = "PrgListOrdenImpoPend"
...
Private Sub Proceso_Click()
    ...
    Listado.WindowTitle = "Listado de Ordenes de Importacion Pendientes de Entrega"
    Listado.WindowTop = -3
    Listado.WindowLeft = -3
    Listado.WindowWidth = Screen.Width
    Listado.WindowHeight = Screen.Height
    
    Uno = "{OrdenImpo.OrdFecEntrega} in " + Chr$(34) + WDesde + Chr$(34) + " to " + Chr$(34) + WHasta + Chr$(34)
    Dos = " and {OrdenImpo.Cliente} in " + Desde.Text + " to " + Hasta.Text
