...
Begin VB.Form PrgCtaCte1Otro 
   ...
   Begin VB.CommandButton CmdClose 
      ...
      Height          =   975
      Left            =   6000
      MouseIcon       =   "ctACTE1Otro.frx":0000
      MousePointer    =   99  'Custom
      Picture         =   "ctACTE1Otro.frx":030A
      Style           =   1  'Graphical
      TabIndex        =   19
      ToolTipText     =   "Salida"
      Top             =   1080
   ...
   Begin VB.CommandButton DatosCli 
      ...
      Height          =   975
      Left            =   4920
      MouseIcon       =   "ctACTE1Otro.frx":0B4C
      MousePointer    =   99  'Custom
      Picture         =   "ctACTE1Otro.frx":0E56
      Style           =   1  'Graphical
      TabIndex        =   18
      ToolTipText     =   "Salida"
      Top             =   1080
   ...
   Begin VB.ListBox Pantalla 
      Height          =   1620
      ItemData        =   "ctACTE1Otro.frx":1B50
      Left            =   120
      List            =   "ctACTE1Otro.frx":1B57
      TabIndex        =   1
      Top             =   480
      Width           =   4335
   End
   ...
   End
End
Attribute VB_Name = "PrgCtaCte1Otro"
                    ...
                    Select Case ZZNivel
                        ...
                        Case 1
                            If rstCtaCte!Totalus > 0 Then
                                Importe1 = rstCtaCte!Totalus
                                Importe2 = 0
                                    Else
                                Importe1 = 0
                                Importe2 = rstCtaCte!Totalus
                            End If
                            Importe3 = rstCtaCte!Saldous
                            Call Redondeo(Importe3)
                            
                        Case Else
                            If rstCtaCte!Total > 0 Then
                                Importe1 = rstCtaCte!Totalus - rstCtaCte!Total
                                Importe2 = 0
                                    Else
                                Importe1 = 0
                                Importe2 = rstCtaCte!Totalus - rstCtaCte!Total
                            End If
                            Importe3 = rstCtaCte!Saldous - rstCtaCte!Saldo
                            Call Redondeo(Importe3)
                    End Select
