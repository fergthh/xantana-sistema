...
Begin VB.Form PrgListDespacho 
   AutoRedraw      =   -1  'True
   Caption         =   "Listado de Despacho de Importacion"
   ClientHeight    =   4605
   ClientLeft      =   2175
   ClientTop       =   735
   ClientWidth     =   8145
   ...
   Begin VB.Frame Frame2 
      ...
      Begin VB.CommandButton Panta 
         ...
         Height          =   975
         Left            =   600
         MouseIcon       =   "listdespacho.frx":0000
         MousePointer    =   99  'Custom
         Picture         =   "listdespacho.frx":030A
         Style           =   1  'Graphical
         TabIndex        =   11
      ...
      Begin VB.CommandButton Impre 
         ...
         Height          =   975
         Left            =   2040
         MouseIcon       =   "listdespacho.frx":0B4C
         MousePointer    =   99  'Custom
         Picture         =   "listdespacho.frx":0E56
         Style           =   1  'Graphical
         TabIndex        =   10
      ...
      Begin VB.CommandButton Cancela 
         ...
         Height          =   975
         Left            =   3360
         MouseIcon       =   "listdespacho.frx":1698
         MousePointer    =   99  'Custom
         Picture         =   "listdespacho.frx":19A2
         Style           =   1  'Graphical
         TabIndex        =   9
         ToolTipText     =   "Salida"
         Top             =   2520
   ...
   Begin Crystal.CrystalReport Listado 
      ...
      _ExtentY        =   741
      _Version        =   262150
      ReportFileName  =   "ListDespacho.rpt"
      Destination     =   1
   ...
   End
End
Attribute VB_Name = "PrgListDespacho"
...
Private Sub Proceso_Click()
    ...
    Listado.WindowTitle = "Listado de Despachos de Importacion"
    Listado.WindowTop = -3
    Listado.WindowLeft = -3
    Listado.WindowWidth = Screen.Width
    Listado.WindowHeight = Screen.Height
    
    Uno = "{Despacho.OrdFecha} in " + Chr$(34) + WDesde + Chr$(34) + " to " + Chr$(34) + WHasta + Chr$(34)
    Dos = " and {Despacho.Orden} in " + Desde.Text + " to " + Hasta.Text
