...
Begin VB.Form PrgListaRete 
   Caption         =   "Listado de Retenciones de Ganancias (Proveedores)"
   ClientHeight    =   3060
   ClientLeft      =   3255
   ClientTop       =   1575
   ClientWidth     =   5775
   ...
   Begin VB.Frame Frame2 
      ...
      Begin VB.CommandButton Panta 
         ...
         Height          =   975
         Left            =   480
         MouseIcon       =   "listarete.frx":0000
         MousePointer    =   99  'Custom
         Picture         =   "listarete.frx":030A
         Style           =   1  'Graphical
         TabIndex        =   8
      ...
      Begin VB.CommandButton Impre 
         ...
         Height          =   975
         Left            =   1800
         MouseIcon       =   "listarete.frx":0B4C
         MousePointer    =   99  'Custom
         Picture         =   "listarete.frx":0E56
         Style           =   1  'Graphical
         TabIndex        =   7
      ...
      Begin VB.CommandButton Cancela 
         ...
         Height          =   975
         Left            =   3120
         MouseIcon       =   "listarete.frx":1698
         MousePointer    =   99  'Custom
         Picture         =   "listarete.frx":19A2
         Style           =   1  'Graphical
         TabIndex        =   6
         ToolTipText     =   "Salida"
         Top             =   1440
   ...
   End
End
Attribute VB_Name = "PrgListaRete"
...
Private Sub Proceso_Click()
    ...
    Listado.SQLQuery = "SELECT Pagos.Orden, Pagos.Renglon, Pagos.Proveedor, Pagos.Fecha, Pagos.FechaOrd, Pagos.Retencion, Pagos.Nroret, " _
