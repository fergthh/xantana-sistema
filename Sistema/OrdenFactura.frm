...
Begin VB.Form PrgOrdenFactura 
   AutoRedraw      =   -1  'True
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Calculo de Orden de Facturacion"
   ClientHeight    =   8175
   ClientLeft      =   930
   ClientTop       =   375
   ClientWidth     =   9615
   ...
   Begin VB.CommandButton Graba 
      ...
      Height          =   975
      Left            =   7800
      MouseIcon       =   "OrdenFactura.frx":0000
      MousePointer    =   99  'Custom
      Picture         =   "OrdenFactura.frx":030A
      Style           =   1  'Graphical
      TabIndex        =   16
   ...
   Begin VB.CommandButton Limpia 
      ...
      Height          =   975
      Left            =   7800
      MouseIcon       =   "OrdenFactura.frx":0B4C
      MousePointer    =   99  'Custom
      Picture         =   "OrdenFactura.frx":0E56
      Style           =   1  'Graphical
      TabIndex        =   15
   ...
   Begin VB.CommandButton Consulta 
      ...
      Height          =   975
      Left            =   7800
      MouseIcon       =   "OrdenFactura.frx":1698
      MousePointer    =   99  'Custom
      Picture         =   "OrdenFactura.frx":19A2
      Style           =   1  'Graphical
      TabIndex        =   14
   ...
   Begin VB.CommandButton CmdClose 
      ...
      Height          =   975
      Left            =   7800
      MouseIcon       =   "OrdenFactura.frx":21E4
      MousePointer    =   99  'Custom
      Picture         =   "OrdenFactura.frx":24EE
      Style           =   1  'Graphical
      TabIndex        =   13
   ...
   Begin VB.ListBox Pantalla 
      ...
      EndProperty
      Height          =   1740
      ItemData        =   "OrdenFactura.frx":2D30
      Left            =   120
      List            =   "OrdenFactura.frx":2D37
      TabIndex        =   0
      Top             =   6240
      Visible         =   0   'False
      Width           =   6855
   ...
   End
End
Attribute VB_Name = "PrgOrdenFactura"
...
Private Sub Graba_Click()
    ...
    WAno = Right$(FechaII.Text, 4)
    WMes = Mid$(FechaII.Text, 4, 2)
    WDia = Left$(FechaII.Text, 2)
    ...
    For iRow = 1 To 100
        ...
        If Trim(Articulo) <> "" Then
            ...
            ZSql = ZSql + "UPDATE Pedido SET "
            ZSql = ZSql + " MarcaII = " + "'" + "S" + "'"
            ZSql = ZSql + " Where Articulo = " + "'" + Articulo + "'"
            spPedido = ZSql
            Set rstPedido = db.OpenRecordset(spPedido, dbOpenSnapshot, dbSQLPassThrough)
    ...
    Listado.SQLQuery = "SELECT Pedido.Numero, Pedido.Articulo, Pedido.Cliente, Pedido.Fecha, Pedido.OrdFecha, Pedido.Observaciones, Pedido.Facturado, Pedido.Partida, Pedido.Talle1, Pedido.Talle2, Pedido.Talle3, Pedido.Talle4, Pedido.Talle5, Pedido.Talle6, Pedido.Talle7, Pedido.Talle8, Pedido.Talle9, Pedido.Talle10, Pedido.Saldo, Pedido.Marca, Pedido.MarcaII, " _
    ...
    Dos = " and {Pedido.Saldo} > 0"
    Tres = " and {Pedido.MarcaII} = " + Chr$(34) + "S" + Chr$(34)
        
    Listado.GroupSelectionFormula = Uno + Dos + Tres
    Listado.SelectionFormula = Uno + Dos + Tres
            
    Listado.ReportFileName = "OrdenFactura.rpt"
...
Private Sub FechaII_Keypress(KeyAscii As Integer)
    If KeyAscii = 13 Then
        Call Valida_fecha(FechaII.Text, Auxi)
        If Auxi = "S" Then
            WVector1.Col = 1
            WVector1.Row = 1
            Call StartEdit
...
Private Sub FechaII_KeyDown(KeyCode As Integer, Shift As Integer)
    If KeyCode = 112 Or KeyCode = 113 Or KeyCode = 114 Or KeyCode = 115 Or KeyCode = 116 Or KeyCode = 117 Or KeyCode = 118 Or KeyCode = 119 Or KeyCode = 120 Or KeyCode = 121 Then
        WFuncion = KeyCode
        Call Ejecuta_Funcion
    End If
