...
Begin VB.Form PrgFacturaProforma 
   AutoRedraw      =   -1  'True
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Ingreso de Facturas Proforma"
   ClientHeight    =   8415
   ClientLeft      =   600
   ClientTop       =   750
   ClientWidth     =   13950
   ...
   Begin VB.ListBox Pantalla 
      Height          =   3420
      ItemData        =   "Facturaproforma.frx":0000
      Left            =   2520
      List            =   "Facturaproforma.frx":0007
      TabIndex        =   1
      Top             =   2640
      Visible         =   0   'False
      Width           =   7335
   ...
   Begin VB.CommandButton Anula 
      ...
      Height          =   855
      Left            =   12960
      MouseIcon       =   "Facturaproforma.frx":0015
      MousePointer    =   99  'Custom
      Picture         =   "Facturaproforma.frx":031F
      Style           =   1  'Graphical
      TabIndex        =   45
   ...
   Begin VB.CommandButton PedidoAyuda 
      ...
      Height          =   975
      Left            =   12960
      MouseIcon       =   "Facturaproforma.frx":0B61
      MousePointer    =   99  'Custom
      Picture         =   "Facturaproforma.frx":0E6B
      Style           =   1  'Graphical
      TabIndex        =   39
   ...
   Begin VB.CommandButton Impresion 
      ...
      Height          =   975
      Left            =   12960
      MouseIcon       =   "Facturaproforma.frx":1735
      MousePointer    =   99  'Custom
      Picture         =   "Facturaproforma.frx":1A3F
      Style           =   1  'Graphical
      TabIndex        =   38
   ...
   Begin VB.CommandButton Graba 
      ...
      Height          =   975
      Left            =   12960
      MouseIcon       =   "Facturaproforma.frx":2281
      MousePointer    =   99  'Custom
      Picture         =   "Facturaproforma.frx":258B
      Style           =   1  'Graphical
      TabIndex        =   37
   ...
   Begin VB.CommandButton CmdDelete 
      ...
      Height          =   855
      Left            =   9120
      MouseIcon       =   "Facturaproforma.frx":2DCD
      MousePointer    =   99  'Custom
      Picture         =   "Facturaproforma.frx":30D7
      Style           =   1  'Graphical
      TabIndex        =   36
      ToolTipText     =   "Elimina el Registro"
      Top             =   4680
   ...
   Begin VB.CommandButton Limpia 
      ...
      Height          =   975
      Left            =   12960
      MouseIcon       =   "Facturaproforma.frx":3919
      MousePointer    =   99  'Custom
      Picture         =   "Facturaproforma.frx":3C23
      Style           =   1  'Graphical
      TabIndex        =   35
   ...
   Begin VB.CommandButton Consulta 
      ...
      Height          =   975
      Left            =   12960
      MouseIcon       =   "Facturaproforma.frx":4465
      MousePointer    =   99  'Custom
      Picture         =   "Facturaproforma.frx":476F
      Style           =   1  'Graphical
      TabIndex        =   34
   ...
   Begin VB.CommandButton CmdClose 
      ...
      Height          =   975
      Left            =   12960
      MouseIcon       =   "Facturaproforma.frx":4FB1
      MousePointer    =   99  'Custom
      Picture         =   "Facturaproforma.frx":52BB
      Style           =   1  'Graphical
      TabIndex        =   33
   ...
   End
End
Attribute VB_Name = "PrgFacturaProforma"
...
Private Sub Impresion_FacturaFe()
    ...
    For a = 1 To 99
        ...
        If Trim(WVector1.TextMatrix(a, 1)) <> "" Then
            ...
            ZZZMoneda = Val(WVector1.TextMatrix(a, 9))
    ...
    Listado.ReportFileName = "ImpreFacturaProforma.rpt"
...
Private Sub Impresion_Click()
    ...
    Rem m$ = "Desea reimprimir la factura"
