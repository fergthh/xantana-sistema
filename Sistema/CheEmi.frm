...
Begin VB.Form PrgCheEmi 
   ...
   Begin VB.Frame Frame2 
      ...
      Begin VB.CommandButton Panta 
         ...
         Height          =   975
         Left            =   240
         MouseIcon       =   "CheEmi.frx":0000
         MousePointer    =   99  'Custom
         Picture         =   "CheEmi.frx":030A
         Style           =   1  'Graphical
         TabIndex        =   15
      ...
      Begin VB.CommandButton Consulta 
         ...
         Height          =   975
         Left            =   2640
         MouseIcon       =   "CheEmi.frx":0B4C
         MousePointer    =   99  'Custom
         Picture         =   "CheEmi.frx":0E56
         Style           =   1  'Graphical
         TabIndex        =   14
      ...
      Begin VB.CommandButton Impre 
         ...
         Height          =   975
         Left            =   1440
         MouseIcon       =   "CheEmi.frx":1698
         MousePointer    =   99  'Custom
         Picture         =   "CheEmi.frx":19A2
         Style           =   1  'Graphical
         TabIndex        =   13
      ...
      Begin VB.CommandButton Cancela 
         ...
         Height          =   975
         Left            =   3840
         MouseIcon       =   "CheEmi.frx":21E4
         MousePointer    =   99  'Custom
         Picture         =   "CheEmi.frx":24EE
         Style           =   1  'Graphical
         TabIndex        =   12
         ToolTipText     =   "Salida"
         Top             =   2160
   ...
   Begin VB.ListBox Pantalla 
      ...
      EndProperty
      Height          =   2595
      ItemData        =   "CheEmi.frx":2D30
      Left            =   240
      List            =   "CheEmi.frx":2D37
      TabIndex        =   1
      Top             =   4080
      Visible         =   0   'False
      Width           =   6375
...
Private Sub Proceso_Click()
    ...
    Listado.WindowTitle = "Listado Cheque Emitidos"
    Listado.WindowTop = 0
    ...
    Listado.SQLQuery = "SELECT Pagos.Proveedor, Pagos.Fecha, Pagos.FechaOrd, Pagos.Tipo2, Pagos.Numero2, Pagos.Fecha2, Pagos.banco2, Pagos.Importe2, Pagos.Observaciones, Pagos.FechaOrd2, " _
                ...
                + "Pagos.banco2 <= " + HastaBanco.Text
    
    Listado.Connect = Connect()
    
    Uno = "{Pagos.banco2} in " + DesdeBanco.Text + " to " + HastaBanco.Text + " and "
    Dos = "{Pagos.FechaOrd} in " + Chr$(34) + WDesde + Chr$(34) + " to " + Chr$(34) + WHasta + Chr$(34) + " and "
    Tres = "{Pagos.Tipo2} = " + Chr$(34) + "02" + Chr$(34)
