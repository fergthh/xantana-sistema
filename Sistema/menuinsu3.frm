...
Begin VB.Form Menu3 
   ...
   EndProperty
   Icon            =   "menuInsu3.frx":0000
   LinkTopic       =   "Form1"
   MouseIcon       =   "menuInsu3.frx":0442
   ScaleHeight     =   8310
   ScaleWidth      =   11640
   ...
   Begin VB.Label Label8 
      Alignment       =   2  'Center
      BackColor       =   &H00FFFF00&
      Caption         =   "6) Verificacion de Stock por Formula"
      BeginProperty Font 
         Name            =   "MS Sans Serif"
         Size            =   13.5
         Charset         =   0
   ...
   Begin VB.Label Label6 
      Alignment       =   2  'Center
      BackColor       =   &H00FFFF00&
      Caption         =   "5) Actualizacion de Costos"
      BeginProperty Font 
         Name            =   "MS Sans Serif"
         Size            =   13.5
         Charset         =   0
   ...
   Begin VB.Label Label4 
      Alignment       =   2  'Center
      BackColor       =   &H00FFFF00&
      Caption         =   "3) Orden de Requisicion"
      BeginProperty Font 
         Name            =   "MS Sans Serif"
         Size            =   13.5
         Charset         =   0
...
Private Sub Form_Load()
    Rem Menu1.Caption = "Sistema de Ventas : " + WNombreEmpresa
End Sub
...
Private Sub Opcion_Keypress(KeyAscii As Integer)
    ...
    If Val(Chr$(KeyAscii)) = 4 Then
        Menu3.Hide
        Unload Me
        PrgMovvarInsumos.Show
    End If
    If Val(Chr$(KeyAscii)) = 5 Then
        Menu3.Hide
        Unload Me
        prgActualizacionGeneralInsumos.Show
    End If
    If Val(Chr$(KeyAscii)) = 6 Then
        Menu3.Hide
        Unload Me
        PrgFormulaStock.Show
    End If
