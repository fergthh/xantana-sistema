...
Begin VB.Form PrgLaudoArchivo 
   ...
   Begin VB.Frame Frame2 
      ...
      Begin VB.Image Cancela 
         Height          =   480
         Left            =   3600
         MouseIcon       =   "LaudoArchivo.frx":0000
         MousePointer    =   99  'Custom
         Picture         =   "LaudoArchivo.frx":030A
      ...
      Begin VB.Image Acepta 
         Height          =   480
         Left            =   2040
         MouseIcon       =   "LaudoArchivo.frx":074C
         MousePointer    =   99  'Custom
         Picture         =   "LaudoArchivo.frx":0A56
   ...
   End
End
Attribute VB_Name = "PrgLaudoArchivo"
