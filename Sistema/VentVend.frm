...
Begin VB.Form PrgVentVend 
   ...
   Begin VB.Frame Frame2 
      ...
      Begin VB.CommandButton Cancela 
         ...
         Height          =   975
         Left            =   3840
         MouseIcon       =   "ventvend.frx":0000
         MousePointer    =   99  'Custom
         Picture         =   "ventvend.frx":030A
         Style           =   1  'Graphical
         TabIndex        =   15
         ToolTipText     =   "Salida"
         Top             =   3240
      ...
      Begin VB.CommandButton Impre 
         ...
         Height          =   975
         Left            =   1440
         MouseIcon       =   "ventvend.frx":0B4C
         MousePointer    =   99  'Custom
         Picture         =   "ventvend.frx":0E56
         Style           =   1  'Graphical
         TabIndex        =   14
      ...
      Begin VB.CommandButton Consulta 
         ...
         Height          =   975
         Left            =   2640
         MouseIcon       =   "ventvend.frx":1698
         MousePointer    =   99  'Custom
         Picture         =   "ventvend.frx":19A2
         Style           =   1  'Graphical
         TabIndex        =   13
      ...
      Begin VB.CommandButton Panta 
         ...
         Height          =   975
         Left            =   240
         MouseIcon       =   "ventvend.frx":21E4
         MousePointer    =   99  'Custom
         Picture         =   "ventvend.frx":24EE
         Style           =   1  'Graphical
         TabIndex        =   12
   ...
   Begin VB.ListBox Pantalla 
      ...
      EndProperty
      Height          =   2400
      ItemData        =   "ventvend.frx":2D30
      Left            =   120
      List            =   "ventvend.frx":2D37
      TabIndex        =   1
      Top             =   5160
      Visible         =   0   'False
      Width           =   7815
...
Private Sub Proceso_Click()
    ...
    If Tipo.ListIndex = 0 Then
        Listado.ReportFileName = "ComiVendedor.rpt"
            Else
        Listado.ReportFileName = "ComiVendedorResu.rpt"
    End If
