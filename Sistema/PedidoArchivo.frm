...
Begin VB.Form PrgPedidoArchivo 
   AutoRedraw      =   -1  'True
   ...
   Begin VB.Frame Frame2 
      ...
      Begin VB.Image Cancela 
         Height          =   480
         Left            =   3600
         MouseIcon       =   "PedidoArchivo.frx":0000
         MousePointer    =   99  'Custom
         Picture         =   "PedidoArchivo.frx":030A
      ...
      Begin VB.Image Acepta 
         Height          =   480
         Left            =   2040
         MouseIcon       =   "PedidoArchivo.frx":074C
         MousePointer    =   99  'Custom
         Picture         =   "PedidoArchivo.frx":0A56
   ...
   End
End
Attribute VB_Name = "PrgPedidoArchivo"
