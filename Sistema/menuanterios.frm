...
Begin VB.Form MenuAnterior 
   ...
   EndProperty
   Icon            =   "menuanterios.frx":0000
   LinkTopic       =   "Form1"
   MouseIcon       =   "menuanterios.frx":0442
   ScaleHeight     =   8190
   ScaleWidth      =   11640
   ...
   Begin VB.Label AdmiII 
      ...
      Height          =   495
      Left            =   960
      MouseIcon       =   "menuanterios.frx":0884
   ...
   Begin VB.Menu Maestros 
      ...
      End
      Begin VB.Menu Ptocue 
         Caption         =   "Ingreso de Presupuesto de Gastos "
      End
   End
   Begin VB.Menu Nov 
      Caption         =   "Novedades"
   ...
   Begin VB.Menu listados 
      ...
      End
      Begin VB.Menu valvarfecha 
         Caption         =   "Listado de Cheques en Cartera a Fecha"
      End
      Begin VB.Menu ListPosdat 
         Caption         =   "Listado de Cheques Posdatados"
      End
      Begin VB.Menu posdatfecha 
         Caption         =   "Listado de Cheques Posdatados a Fecha"
      End
      Begin VB.Menu ListCheque 
         Caption         =   "Listado de Cheques Emitidos"
      End
      Begin VB.Menu ComparaGas 
         Caption         =   "Listado de Control de Gastos "
      End
   ...
   End
End
Attribute VB_Name = "MenuAnterior"
