...
Begin VB.Form PrgListaPagosFecha 
   AutoRedraw      =   -1  'True
   ...
   Begin VB.Frame Frame2 
      ...
      Begin VB.CommandButton Panta 
         ...
         Height          =   975
         Left            =   240
         MouseIcon       =   "listapagosfecha.frx":0000
         MousePointer    =   99  'Custom
         Picture         =   "listapagosfecha.frx":030A
         Style           =   1  'Graphical
         TabIndex        =   11
      ...
      Begin VB.CommandButton Consulta 
         ...
         Height          =   975
         Left            =   2880
         MouseIcon       =   "listapagosfecha.frx":0B4C
         MousePointer    =   99  'Custom
         Picture         =   "listapagosfecha.frx":0E56
         Style           =   1  'Graphical
         TabIndex        =   10
      ...
      Begin VB.CommandButton Impre 
         ...
         Height          =   975
         Left            =   1560
         MouseIcon       =   "listapagosfecha.frx":1698
         MousePointer    =   99  'Custom
         Picture         =   "listapagosfecha.frx":19A2
         Style           =   1  'Graphical
         TabIndex        =   9
      ...
      Begin VB.CommandButton Cancela 
         ...
         Height          =   975
         Left            =   4200
         MouseIcon       =   "listapagosfecha.frx":21E4
         MousePointer    =   99  'Custom
         Picture         =   "listapagosfecha.frx":24EE
         Style           =   1  'Graphical
         TabIndex        =   8
         ToolTipText     =   "Salida"
         Top             =   1200
   ...
   Begin Crystal.CrystalReport Listado 
      ...
      _ExtentY        =   741
      _Version        =   262150
      ReportFileName  =   "ListaPagosFecha.rpt"
      Destination     =   1
   ...
   Begin VB.ListBox Pantalla 
      ...
      EndProperty
      Height          =   2595
      ItemData        =   "listapagosfecha.frx":2D30
      Left            =   360
      List            =   "listapagosfecha.frx":2D37
      TabIndex        =   1
      Top             =   3120
      Visible         =   0   'False
      Width           =   6375
   End
End
Attribute VB_Name = "PrgListaPagosFecha"
...
Private Sub Proceso_Click()
    ...
    If Val(WEmpresa) = 1 Then
        ZVarios = "Listado de Pagos por Fecha"
            Else
        ZVarios = "*****   Listado de Pagos por Fecha  ********"
    End If
    ...
    Listado.SQLQuery = "SELECT Pagos.Orden, Pagos.Proveedor, Pagos.Fecha, Pagos.FechaOrd, Pagos.Tipo1, Pagos.Numero1, Pagos.Importe1, Pagos.Fecha2, Pagos.Observaciones, " _
