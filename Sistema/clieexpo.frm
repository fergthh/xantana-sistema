...
Begin VB.Form PrgClieExpo 
   ...
   Begin VB.Frame Frame2 
      ...
      Begin VB.CommandButton Cancela 
         ...
         Height          =   975
         Left            =   4440
         MouseIcon       =   "clieexpo.frx":0000
         MousePointer    =   99  'Custom
         Picture         =   "clieexpo.frx":030A
         Style           =   1  'Graphical
         TabIndex        =   26
      ...
      Begin VB.CommandButton Acepta 
         ...
         Height          =   975
         Left            =   3360
         MouseIcon       =   "clieexpo.frx":074C
         MousePointer    =   99  'Custom
         Picture         =   "clieexpo.frx":0A56
         Style           =   1  'Graphical
         TabIndex        =   25
         ToolTipText     =   "Graba los Datos Ingresados"
         Top             =   600
   ...
   Begin VB.CommandButton Ultimo 
      ...
      Height          =   975
      Left            =   6960
      MouseIcon       =   "clieexpo.frx":0E98
      MousePointer    =   99  'Custom
      Picture         =   "clieexpo.frx":11A2
      Style           =   1  'Graphical
      TabIndex        =   24
      ToolTipText     =   "Salida"
      Top             =   2400
   ...
   Begin VB.CommandButton Siguiente 
      ...
      Height          =   975
      Left            =   6000
      MouseIcon       =   "clieexpo.frx":15E4
      MousePointer    =   99  'Custom
      Picture         =   "clieexpo.frx":18EE
      Style           =   1  'Graphical
      TabIndex        =   23
   ...
   Begin VB.CommandButton Anterior 
      ...
      Height          =   975
      Left            =   5040
      MouseIcon       =   "clieexpo.frx":1D30
      MousePointer    =   99  'Custom
      Picture         =   "clieexpo.frx":203A
      Style           =   1  'Graphical
      TabIndex        =   22
   ...
   Begin VB.CommandButton Primer 
      ...
      Height          =   975
      Left            =   4080
      MouseIcon       =   "clieexpo.frx":247C
      MousePointer    =   99  'Custom
      Picture         =   "clieexpo.frx":2786
      Style           =   1  'Graphical
      TabIndex        =   21
   ...
   Begin VB.CommandButton CmdClose 
      ...
      Height          =   975
      Left            =   8880
      MouseIcon       =   "clieexpo.frx":2BC8
      MousePointer    =   99  'Custom
      Picture         =   "clieexpo.frx":2ED2
      Style           =   1  'Graphical
      TabIndex        =   20
      ToolTipText     =   "Salida"
      Top             =   2400
   ...
   Begin VB.CommandButton Lista 
      ...
      Height          =   975
      Left            =   7920
      MouseIcon       =   "clieexpo.frx":3714
      MousePointer    =   99  'Custom
      Picture         =   "clieexpo.frx":3A1E
      Style           =   1  'Graphical
      TabIndex        =   19
   ...
   Begin VB.CommandButton Consulta 
      ...
      Height          =   975
      Left            =   3120
      MouseIcon       =   "clieexpo.frx":4260
      MousePointer    =   99  'Custom
      Picture         =   "clieexpo.frx":456A
      Style           =   1  'Graphical
      TabIndex        =   18
   ...
   Begin VB.CommandButton CmdLimpiar 
      ...
      Height          =   975
      Left            =   2160
      MouseIcon       =   "clieexpo.frx":4DAC
      MousePointer    =   99  'Custom
      Picture         =   "clieexpo.frx":50B6
      Style           =   1  'Graphical
      TabIndex        =   17
   ...
   Begin VB.CommandButton CmdDelete 
      ...
      Height          =   975
      Left            =   1200
      MouseIcon       =   "clieexpo.frx":58F8
      MousePointer    =   99  'Custom
      Picture         =   "clieexpo.frx":5C02
      Style           =   1  'Graphical
      TabIndex        =   16
   ...
   Begin VB.CommandButton CmdAdd 
      ...
      Height          =   975
      Left            =   240
      MouseIcon       =   "clieexpo.frx":6444
      MousePointer    =   99  'Custom
      Picture         =   "clieexpo.frx":674E
      Style           =   1  'Graphical
      TabIndex        =   15
      ToolTipText     =   "Graba los Datos Ingresados"
      Top             =   2400
   ...
   Begin VB.ListBox Pantalla 
      ...
      EndProperty
      Height          =   2940
      ItemData        =   "clieexpo.frx":6F90
      Left            =   120
      List            =   "clieexpo.frx":6F97
      TabIndex        =   4
      Top             =   3960
      Visible         =   0   'False
      Width           =   8175
...
Private Sub Acepta_Click()
    ...
    If Val(Hasta.Text) = 0 Then
         Hasta.Text = "0"
    End If
    Listado.GroupSelectionFormula = "{ClieExpo.Codigo} in " + Desde.Text + " to " + Hasta.Text
