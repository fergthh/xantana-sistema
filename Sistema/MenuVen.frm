...
Begin VB.Form MenuVen 
   ...
   Begin VB.Menu sadfdsf 
      ...
      End
      Begin VB.Menu Tipo 
         Caption         =   "Ingreso de Tipo de Productos"
      End
      Begin VB.Menu Fragancia 
         Caption         =   "Ingreso de Fragancias"
      End
      Begin VB.Menu Calidad 
         Caption         =   "Ingreso de Calidad"
      End
      Begin VB.Menu Tamaño 
         Caption         =   "Ingreso de Tamaño"
      End
      Begin VB.Menu Sector 
         Caption         =   "Ingreso de Sector"
      End
      Begin VB.Menu CondPago 
         Caption         =   "Condiciones de Pago"
      End
      Begin VB.Menu TipoClie 
         Caption         =   "Tipo de Clientes"
      End
      Begin VB.Menu lista 
         Caption         =   "Lista de Precios"
      End
      Begin VB.Menu Paridad 
         Caption         =   "Ingreso de Paridad"
      End
      Begin VB.Menu ConceptoStock 
         Caption         =   "Ingreso de Conceptos de Movimientos de Stock"
      End
   End
   Begin VB.Menu fgnhghj 
      Caption         =   "Articulos e Insumos"
      ...
      End
      Begin VB.Menu Combo 
         Caption         =   "Ingreso de Combos"
      End
      Begin VB.Menu Formula 
         Caption         =   "Ingreso de Formulas"
      End
      Begin VB.Menu fdgdfhdgdfg 
         Caption         =   "--------------------------------------"
      End
      Begin VB.Menu HojaProduccion 
         Caption         =   "Ingreso de Hoja de Packaging"
      End
      Begin VB.Menu drertger 
         Caption         =   "Ingreso de Produccion Interna"
         Visible         =   0   'False
      End
      Begin VB.Menu OrdenCpaArti 
         Caption         =   "Ingreso de Ordenes de Comrpra"
      End
      Begin VB.Menu asdasdsadasd 
         Caption         =   "--------------------------------------"
      End
      Begin VB.Menu ListadoSolInsumosII 
         Caption         =   "Listado de Solicitud de Insumos Pendientes de Entrega"
      End
      Begin VB.Menu ListaOrdenCpaPendiente 
         Caption         =   "Listado de Ordens de Compra Pendientes de Entrega"
      End
      Begin VB.Menu sdfds 
      ...
      Begin VB.Menu ListaStockValora 
         Caption         =   "Valorizacion de Stock de Insumos"
      End
      Begin VB.Menu ListaaRTIValora 
         Caption         =   "Valorizacion de Stock de Articulos"
      End
      Begin VB.Menu ListaDisponible 
         Caption         =   "Listado de Disponible"
      End
   End
   Begin VB.Menu Nov 
      Caption         =   "Ventas"
   ...
   Begin VB.Menu adasdsadasdasdsad 
      ...
      Begin VB.Menu ListadoSolInsumos 
         Caption         =   "Listado de Solicitud de Insumos Pendientes de Procesar"
      End
      ...
      End
      Begin VB.Menu ListamovInsumos 
         Caption         =   "Listado de Remitos"
      End
      Begin VB.Menu listamovimietosnsumos 
         Caption         =   "Listado de Movimienos de Insumos"
      End
   End
   Begin VB.Menu fgh 
      Caption         =   "Procesos"
      ...
      End
      Begin VB.Menu ponercero 
         Caption         =   "Puesta en Cero de Stock"
      End
...
Stop
    ...
    Do
        ...
        If Trim(WCodigo) <> "" And Trim(WDesde) <> "" Then
...
Stop
    ...
    Do
        ...
        If rstCliente.RecordCount > 0 Then
            ...
            Rem ZSql = ZSql + " Razon = " + "'" + WFantasia + "',"
            ZSql = ZSql + " Direccion = " + "'" + ZZDireccion + "'"
            Rem ZSql = ZSql + " Localidad = " + "'" + WLocalidad + "',"
            Rem ZSql = ZSql + " Postal = " + "'" + WPostal + "',"
            Rem ZSql = ZSql + " Telefono = " + "'" + WTelefono + "',"
            Rem ZSql = ZSql + " NombreI = " + "'" + WContactoI + "',"
            Rem ZSql = ZSql + " TelefonoI = " + "'" + WTelefonoI + "',"
            Rem ZSql = ZSql + " NombreII = " + "'" + WContactoII + "',"
            Rem ZSql = ZSql + " TelefonoII = " + "'" + WTelefonoII + "',"
            Rem ZSql = ZSql + " NombreIII = " + "'" + WContactoIII + "',"
            Rem ZSql = ZSql + " TelefonoIII = " + "'" + WTelefonoIII + "',"
            Rem ZSql = ZSql + " Fantasia = " + "'" + WRazon + "',"
            Rem ZSql = ZSql + " DireccionII = " + "'" + ZZDireccionII + "',"
            Rem ZSql = ZSql + " LocalidadII = " + "'" + WLocalidadII + "',"
            Rem ZSql = ZSql + " PostalII = " + "'" + WPostalII + "',"
            Rem ZSql = ZSql + " Cuit = " + "'" + Left$(WCuit, 15) + "',"
            Rem ZSql = ZSql + " Email = " + "'" + WEmail + "',"
            Rem ZSql = ZSql + " Fax = " + "'" + WFax + "',"
            Rem ZSql = ZSql + " ImpreProvincia = " + "'" + WImpreProvincia + "',"
            Rem ZSql = ZSql + " ImpreProvinciaII = " + "'" + WImpreProvinciaII + "',"
            Rem ZSql = ZSql + " Iva = " + "'" + WIva + "',"
            Rem ZSql = ZSql + " Expreso = " + "'" + WExpreso + "',"
            Rem ZSql = ZSql + " TipoClie = " + "'" + WTipoClie + "',"
            Rem ZSql = ZSql + " NroLista = " + "'" + WLista + "'"
...
Private Sub ConceptoStock_Click()
    PrgConceptoStock.Show
End Sub
...
Private Sub EstaArt_Click()
    PrgEstaart.Show
End Sub

Private Sub Estacli_Click()
    PrgEstaCliente.Show
End Sub
...
Private Sub Form_Load()
   MenuVen.Caption = "Sistema de Ventas"
End Sub
...
Private Sub ListaaRTIValora_Click()
    PrgListaStockValora.Show
End Sub

Private Sub ListaDisponible_Click()
    PrgListaDisponible.Show
End Sub
...
Private Sub listamovimietosnsumos_Click()
    PrgListaMovimientosInsumos.Show
End Sub

Private Sub listamovinsumos_Click()
    PrgListaMovInsumos.Show
End Sub
...
Private Sub LiustamovInsumos_Click()
...
Private Sub Form_Activate()
    MenuVen.Caption = "Sistema de Ventas : " + WNombreEmpresa
End Sub
