...
Begin VB.Form Menu21 
   ...
   EndProperty
   Icon            =   "menu21.frx":0000
   LinkTopic       =   "Form1"
   MouseIcon       =   "menu21.frx":0442
   ScaleHeight     =   8310
   ScaleWidth      =   11640
   ...
   Begin VB.Label Label9 
      Alignment       =   2  'Center
      BackColor       =   &H00FFFF00&
      Caption         =   "7) Lista de Precios  (Futuro)"
      BeginProperty Font 
         Name            =   "MS Sans Serif"
         Size            =   13.5
         Charset         =   0
   ...
   Begin VB.Label Label8 
      Alignment       =   2  'Center
      BackColor       =   &H00FFFF00&
      Caption         =   "6) Lista de Precios (Cliente)"
      BeginProperty Font 
         Name            =   "MS Sans Serif"
         Size            =   13.5
         Charset         =   0
   ...
   Begin VB.Label Label6 
      Alignment       =   2  'Center
      BackColor       =   &H00FFFF00&
      Caption         =   "5) Lista de Precios S.D.T. y C.B. por grupos"
      BeginProperty Font 
         Name            =   "MS Sans Serif"
         Size            =   13.5
         Charset         =   0
   ...
   Begin VB.Label Label4 
      Alignment       =   2  'Center
      BackColor       =   &H00FFFF00&
      Caption         =   "3) Novedades de Precios"
      BeginProperty Font 
         Name            =   "MS Sans Serif"
         Size            =   13.5
         Charset         =   0
   ...
   Begin VB.Label Label2 
      Alignment       =   2  'Center
      BackColor       =   &H00FFFF00&
      Caption         =   "1)  Costos por Proveedor"
      BeginProperty Font 
         Name            =   "MS Sans Serif"
         Size            =   13.5
         Charset         =   0
...
Private Sub Opcion_Keypress(KeyAscii As Integer)
    ...
    If Val(Chr$(KeyAscii)) = 5 Then
        Menu21.Hide
        Unload Me
        PrgListaPreciosVendedor.Show
    End If
    If Val(Chr$(KeyAscii)) = 6 Then
        Menu21.Hide
        Unload Me
        PrgListaPreciosCliente.Show
    End If
    If Val(Chr$(KeyAscii)) = 7 Then
        Menu21.Hide
        Unload Me
        PrgListaPreciosFuturo.Show
    End If
    If Val(Chr$(KeyAscii)) = 8 Then
        Menu21.Hide
        Unload Me
        PrgListaPreciosGrupo.Show
    End If
    If KeyAscii = 27 Then
        Menu21.Hide
        Unload Me
