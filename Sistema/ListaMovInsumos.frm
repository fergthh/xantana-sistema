...
Begin VB.Form PrgListaMovInsumos 
   AutoRedraw      =   -1  'True
   ...
   Begin VB.Frame Frame2 
      ...
      Begin VB.CommandButton Cancela 
         ...
         Height          =   975
         Left            =   4080
         MouseIcon       =   "ListaMovInsumos.frx":0000
         MousePointer    =   99  'Custom
         Picture         =   "ListaMovInsumos.frx":030A
         Style           =   1  'Graphical
         TabIndex        =   8
         ToolTipText     =   "Salida"
         Top             =   1440
      ...
      Begin VB.CommandButton Impre 
         ...
         Height          =   975
         Left            =   2280
         MouseIcon       =   "ListaMovInsumos.frx":0B4C
         MousePointer    =   99  'Custom
         Picture         =   "ListaMovInsumos.frx":0E56
         Style           =   1  'Graphical
         TabIndex        =   7
      ...
      Begin VB.CommandButton Panta 
         ...
         Height          =   975
         Left            =   480
         MouseIcon       =   "ListaMovInsumos.frx":1698
         MousePointer    =   99  'Custom
         Picture         =   "ListaMovInsumos.frx":19A2
         Style           =   1  'Graphical
         TabIndex        =   6
   ...
   End
End
Attribute VB_Name = "PrgListaMovInsumos"
