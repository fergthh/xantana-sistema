...
Begin VB.Form PrgPedidoAuto 
   ...
   Begin VB.CommandButton ImpresionII 
      ...
      Height          =   975
      Left            =   12840
      MouseIcon       =   "pedidoauto.frx":0000
      MousePointer    =   99  'Custom
      Picture         =   "pedidoauto.frx":030A
      Style           =   1  'Graphical
      TabIndex        =   43
   ...
   Begin VB.CommandButton CmdClose 
      ...
      Height          =   975
      Left            =   13800
      MouseIcon       =   "pedidoauto.frx":0B4C
      MousePointer    =   99  'Custom
      Picture         =   "pedidoauto.frx":0E56
      Style           =   1  'Graphical
      TabIndex        =   24
   ...
   Begin VB.CommandButton Consulta 
      ...
      Height          =   975
      Left            =   11880
      MouseIcon       =   "pedidoauto.frx":1698
      MousePointer    =   99  'Custom
      Picture         =   "pedidoauto.frx":19A2
      Style           =   1  'Graphical
      TabIndex        =   23
   ...
   Begin VB.CommandButton Limpia 
      ...
      Height          =   975
      Left            =   10920
      MouseIcon       =   "pedidoauto.frx":21E4
      MousePointer    =   99  'Custom
      Picture         =   "pedidoauto.frx":24EE
      Style           =   1  'Graphical
      TabIndex        =   22
   ...
   Begin VB.CommandButton CmdDelete 
      ...
      Height          =   975
      Left            =   9960
      MouseIcon       =   "pedidoauto.frx":2D30
      MousePointer    =   99  'Custom
      Picture         =   "pedidoauto.frx":303A
      Style           =   1  'Graphical
      TabIndex        =   21
   ...
   Begin VB.CommandButton Graba 
      ...
      Height          =   975
      Left            =   9000
      MouseIcon       =   "pedidoauto.frx":387C
      MousePointer    =   99  'Custom
      Picture         =   "pedidoauto.frx":3B86
      Style           =   1  'Graphical
      TabIndex        =   20
   ...
   Begin VB.ListBox Pantalla 
      Height          =   1500
      ItemData        =   "pedidoauto.frx":43C8
      Left            =   240
      List            =   "pedidoauto.frx":43CF
      TabIndex        =   2
      Top             =   6240
      Visible         =   0   'False
      Width           =   8655
   ...
   End
End
Attribute VB_Name = "PrgPedidoAuto"
...
Private Sub Proceso_Click()
    ...
    For WRenglon = 1 To 99
        ...
        If rstPedido.RecordCount > 0 Then
            ...
            WVector1.Col = 16
            WVector1.Text = Str$(rstPedido!Entregado)
    ...
    Select Case XColumna
        Case 1
            ...
            If rstArticulo.RecordCount > 0 Then
                ...
                WWImporteII = WWImporte / WWParidad * WWCanti
...
Private Sub Calcula_Costo()
    ...
    Set rstPrecios = db.OpenRecordset(spPrecios, dbOpenSnapshot, dbSQLPassThrough)
    If rstPrecios.RecordCount > 0 Then
        If rstPrecios!OrdHasta > WWOrdDesde Then
            WWTope1 = rstPrecios!Tope1
            WWValor1 = rstPrecios!Valor1
            WWTope2 = rstPrecios!Tope2
            WWValor2 = rstPrecios!Valor2
