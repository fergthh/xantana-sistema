...
Begin VB.Form PrgOrdenCompra 
   ...
   Begin VB.CommandButton ImpresionII 
      ...
      Height          =   975
      Left            =   12600
      MouseIcon       =   "ORDENCOMPRA.frx":0000
      MousePointer    =   99  'Custom
      Picture         =   "ORDENCOMPRA.frx":030A
      Style           =   1  'Graphical
      TabIndex        =   33
   ...
   Begin VB.CommandButton SolicitudAyuda 
      ...
      Height          =   975
      Left            =   13560
      MouseIcon       =   "ORDENCOMPRA.frx":0B4C
      MousePointer    =   99  'Custom
      Picture         =   "ORDENCOMPRA.frx":0E56
      Style           =   1  'Graphical
      TabIndex        =   29
   ...
   Begin VB.CommandButton Graba 
      ...
      Height          =   975
      Left            =   12600
      MouseIcon       =   "ORDENCOMPRA.frx":1720
      MousePointer    =   99  'Custom
      Picture         =   "ORDENCOMPRA.frx":1A2A
      Style           =   1  'Graphical
      TabIndex        =   21
   ...
   Begin VB.CommandButton Limpia 
      ...
      Height          =   975
      Left            =   12600
      MouseIcon       =   "ORDENCOMPRA.frx":226C
      MousePointer    =   99  'Custom
      Picture         =   "ORDENCOMPRA.frx":2576
      Style           =   1  'Graphical
      TabIndex        =   20
   ...
   Begin VB.CommandButton Consulta 
      ...
      Height          =   975
      Left            =   13560
      MouseIcon       =   "ORDENCOMPRA.frx":2DB8
      MousePointer    =   99  'Custom
      Picture         =   "ORDENCOMPRA.frx":30C2
      Style           =   1  'Graphical
      TabIndex        =   19
   ...
   Begin VB.CommandButton CmdClose 
      ...
      Height          =   975
      Left            =   13560
      MouseIcon       =   "ORDENCOMPRA.frx":3904
      MousePointer    =   99  'Custom
      Picture         =   "ORDENCOMPRA.frx":3C0E
      Style           =   1  'Graphical
      TabIndex        =   18
   ...
   Begin VB.ListBox Pantalla 
      ...
      EndProperty
      Height          =   3420
      ItemData        =   "ORDENCOMPRA.frx":4450
      Left            =   120
      List            =   "ORDENCOMPRA.frx":4457
      TabIndex        =   1
      Top             =   6240
      Visible         =   0   'False
      Width           =   12375
...
Private Sub Graba_Click()
    ...
    ZSql = ZSql + " Where MovimientoInsumo.Tipo = " + "'" + "10" + "'"
...
Private Sub Impresion()
    ...
    Listado.SQLQuery = "SELECT Orden.Numero, Orden.Renglon, Orden.Proveedor, Orden.Fecha, Orden.Cantidad, Orden.Observaciones, Orden.Precio,  Orden.Moneda, Orden.ObservaII, " _
            + "Proveedor.Nombre, " _
            + "Insumo.Descripcion " _
            + "From " _
            + DSQ + ".dbo.Orden Orden, " _
