...
Begin VB.Form PrgLugar 
   ...
   Begin VB.CommandButton CmdLimpiar 
      ...
      Height          =   975
      Left            =   2160
      MouseIcon       =   "Lugar.frx":0000
      MousePointer    =   99  'Custom
      Picture         =   "Lugar.frx":030A
      Style           =   1  'Graphical
      TabIndex        =   34
   ...
   Begin VB.Frame Frame2 
      ...
      Begin VB.CommandButton Cancela 
         ...
         Height          =   975
         Left            =   4440
         MouseIcon       =   "Lugar.frx":0B4C
         MousePointer    =   99  'Custom
         Picture         =   "Lugar.frx":0E56
         Style           =   1  'Graphical
         TabIndex        =   25
      ...
      Begin VB.CommandButton Acepta 
         ...
         Height          =   975
         Left            =   3360
         MouseIcon       =   "Lugar.frx":1298
         MousePointer    =   99  'Custom
         Picture         =   "Lugar.frx":15A2
         Style           =   1  'Graphical
         TabIndex        =   24
         ToolTipText     =   "Graba los Datos Ingresados"
         Top             =   600
   ...
   Begin VB.CommandButton Ultimo 
      ...
      Height          =   975
      Left            =   6960
      MouseIcon       =   "Lugar.frx":19E4
      MousePointer    =   99  'Custom
      Picture         =   "Lugar.frx":1CEE
      Style           =   1  'Graphical
      TabIndex        =   23
      ToolTipText     =   "Salida"
      Top             =   2400
   ...
   Begin VB.CommandButton Siguiente 
      ...
      Height          =   975
      Left            =   6000
      MouseIcon       =   "Lugar.frx":2130
      MousePointer    =   99  'Custom
      Picture         =   "Lugar.frx":243A
      Style           =   1  'Graphical
      TabIndex        =   22
   ...
   Begin VB.CommandButton Anterior 
      ...
      Height          =   975
      Left            =   5040
      MouseIcon       =   "Lugar.frx":287C
      MousePointer    =   99  'Custom
      Picture         =   "Lugar.frx":2B86
      Style           =   1  'Graphical
      TabIndex        =   21
   ...
   Begin VB.CommandButton Primer 
      ...
      Height          =   975
      Left            =   4080
      MouseIcon       =   "Lugar.frx":2FC8
      MousePointer    =   99  'Custom
      Picture         =   "Lugar.frx":32D2
      Style           =   1  'Graphical
      TabIndex        =   20
   ...
   Begin VB.CommandButton CmdClose 
      ...
      Height          =   975
      Left            =   8880
      MouseIcon       =   "Lugar.frx":3714
      MousePointer    =   99  'Custom
      Picture         =   "Lugar.frx":3A1E
      Style           =   1  'Graphical
      TabIndex        =   19
      ToolTipText     =   "Salida"
      Top             =   2400
   ...
   Begin VB.CommandButton Lista 
      ...
      Height          =   975
      Left            =   7920
      MouseIcon       =   "Lugar.frx":4260
      MousePointer    =   99  'Custom
      Picture         =   "Lugar.frx":456A
      Style           =   1  'Graphical
      TabIndex        =   18
   ...
   Begin VB.CommandButton Consulta 
      ...
      Height          =   975
      Left            =   3120
      MouseIcon       =   "Lugar.frx":4DAC
      MousePointer    =   99  'Custom
      Picture         =   "Lugar.frx":50B6
      Style           =   1  'Graphical
      TabIndex        =   17
   ...
   Begin VB.CommandButton CmdDelete 
      ...
      Height          =   975
      Left            =   1200
      MouseIcon       =   "Lugar.frx":58F8
      MousePointer    =   99  'Custom
      Picture         =   "Lugar.frx":5C02
      Style           =   1  'Graphical
      TabIndex        =   16
   ...
   Begin VB.CommandButton CmdAdd 
      ...
      Height          =   975
      Left            =   240
      MouseIcon       =   "Lugar.frx":6444
      MousePointer    =   99  'Custom
      Picture         =   "Lugar.frx":674E
      Style           =   1  'Graphical
      TabIndex        =   15
      ToolTipText     =   "Graba los Datos Ingresados"
      Top             =   2400
...
Private Sub Acepta_Click()
    ...
    If Val(Hasta.Text) = 0 Then
         Hasta.Text = "0"
    End If
    Listado.GroupSelectionFormula = "{Lugar.Codigo} in " + Desde.Text + " to " + Hasta.Text
    ...
    With rstLugar
        ...
        If .NoMatch = False Then
            ...
            If .BOF = True Then
                ...
                a% = MsgBox(m$, 0, "Archivo de Lugares de Entrega")
                .MoveFirst
            End If
            Codigo.Text = !Codigo
            Call Imprime_Datos
...
Error_primer:
     coderr = Err
     Call Errores(coderr, "Lugar de Entrega", "No existe registro en el archivo")
     Call CmdLimpiar_Click
     Codigo.SetFocus
 End Sub
...
Private Sub Codigo_DblClick()
    ...
    Opcion.Clear
    Opcion.AddItem "Lugar de Entrega"
    Rem Opcion.Visible = True
    Opcion.ListIndex = 0
