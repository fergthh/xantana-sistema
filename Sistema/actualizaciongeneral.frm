...
Begin VB.Form prgActualizacionGeneral 
   AutoRedraw      =   -1  'True
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Actualizacion General de Productos"
   ClientHeight    =   6525
   ClientLeft      =   75
   ClientTop       =   360
   ClientWidth     =   11790
   ...
   Begin VB.CommandButton CmdAdd 
      ...
      Height          =   975
      Left            =   360
      MouseIcon       =   "actualizaciongeneral.frx":0000
      MousePointer    =   99  'Custom
      Picture         =   "actualizaciongeneral.frx":030A
      Style           =   1  'Graphical
      TabIndex        =   11
   ...
   Begin VB.CommandButton CmdLimpiar 
      ...
      Height          =   975
      Left            =   1320
      MouseIcon       =   "actualizaciongeneral.frx":0B4C
      MousePointer    =   99  'Custom
      Picture         =   "actualizaciongeneral.frx":0E56
      Style           =   1  'Graphical
      TabIndex        =   10
   ...
   Begin VB.CommandButton Consulta 
      ...
      Height          =   975
      Left            =   2280
      MouseIcon       =   "actualizaciongeneral.frx":1698
      MousePointer    =   99  'Custom
      Picture         =   "actualizaciongeneral.frx":19A2
      Style           =   1  'Graphical
      TabIndex        =   9
   ...
   Begin VB.CommandButton CmdClose 
      ...
      Height          =   975
      Left            =   3240
      MouseIcon       =   "actualizaciongeneral.frx":21E4
      MousePointer    =   99  'Custom
      Picture         =   "actualizaciongeneral.frx":24EE
      Style           =   1  'Graphical
      TabIndex        =   8
      ToolTipText     =   "Salida"
      Top             =   2640
   ...
   Begin VB.ListBox Pantalla 
      ...
      EndProperty
      Height          =   2220
      ItemData        =   "actualizaciongeneral.frx":2D30
      Left            =   120
      List            =   "actualizaciongeneral.frx":2D37
      TabIndex        =   0
      Top             =   4080
      Visible         =   0   'False
      Width           =   8655
   ...
   End
End
Attribute VB_Name = "prgActualizacionGeneral"
...
Private Sub cmdAdd_Click()
    ...
    ZSql = ZSql + " Where Articulo.Codigo >= " + "'" + DesdeArt.Text + "'"
    ZSql = ZSql + " and Articulo.Codigo <= " + "'" + HastaArt.Text + "'"
    If Val(Grupo.Text) <> 0 Then
        ZSql = ZSql + " and Articulo.Grupo = " + "'" + Grupo.Text + "'"
    End If
    If Val(Proveedor.Text) <> 0 Then
        ZSql = ZSql + " and Articulo.Proveedor = " + "'" + Proveedor.Text + "'"
    End If
    spArticulo = ZSql
...
Private Sub DesdeArt_Keypress(KeyAscii As Integer)
    If KeyAscii = 13 Then
        Auxi = UCase(Left$(DesdeArt.Text, 1))
        Auxi1 = Mid$(DesdeArt.Text, 2, 5)
        Call Ceros(Auxi1, 5)
        DesdeArt.Text = Auxi + Auxi1
        HastaArt.SetFocus
    End If
    If KeyAscii = 27 Then
        HastaArt.Text = ""
...
Private Sub HastaArt_Keypress(KeyAscii As Integer)
    If KeyAscii = 13 Then
        Auxi = UCase(Left$(HastaArt.Text, 1))
        Auxi1 = Mid$(HastaArt.Text, 2, 5)
        Call Ceros(Auxi1, 5)
        HastaArt.Text = Auxi + Auxi1
        Margen.SetFocus
    End If
    If KeyAscii = 27 Then
        HastaArt.Text = ""
        ...
        Case 0
            ...
            If rstFamilia.RecordCount > 0 Then
                With rstFamilia
                    ...
                    Do
                        If .EOF = False Then
                            IngresaItem = Str$(rstFamilia!Codigo) + " " + rstFamilia!Descripcion
                            Pantalla.AddItem IngresaItem
                            IngresaItem = rstFamilia!Codigo
