...
Begin VB.Form PrgRankProv 
   AutoRedraw      =   -1  'True
   Caption         =   "Listado de Ranking de Compras por Proveedor"
   ClientHeight    =   6795
   ClientLeft      =   3240
   ClientTop       =   1065
   ClientWidth     =   5655
   ...
   Begin VB.Frame Frame2 
      ...
      Begin VB.CommandButton Consulta 
         ...
         Height          =   975
         Left            =   2880
         MouseIcon       =   "rankprov.frx":0000
         MousePointer    =   99  'Custom
         Picture         =   "rankprov.frx":030A
         Style           =   1  'Graphical
         TabIndex        =   15
      ...
      Begin VB.CommandButton Panta 
         ...
         Height          =   975
         Left            =   240
         MouseIcon       =   "rankprov.frx":0B4C
         MousePointer    =   99  'Custom
         Picture         =   "rankprov.frx":0E56
         Style           =   1  'Graphical
         TabIndex        =   14
      ...
      Begin VB.CommandButton Impre 
         ...
         Height          =   975
         Left            =   1560
         MouseIcon       =   "rankprov.frx":1698
         MousePointer    =   99  'Custom
         Picture         =   "rankprov.frx":19A2
         Style           =   1  'Graphical
         TabIndex        =   13
      ...
      Begin VB.CommandButton Cancela 
         ...
         Height          =   975
         Left            =   4200
         MouseIcon       =   "rankprov.frx":21E4
         MousePointer    =   99  'Custom
         Picture         =   "rankprov.frx":24EE
         Style           =   1  'Graphical
         TabIndex        =   12
         ToolTipText     =   "Salida"
         Top             =   2040
   ...
   Begin VB.ListBox Pantalla 
      ...
      EndProperty
      Height          =   2790
      ItemData        =   "rankprov.frx":2D30
      Left            =   120
      List            =   "rankprov.frx":2D37
      TabIndex        =   2
      Top             =   3960
      Visible         =   0   'False
      Width           =   5415
...
Private Sub Proceso_Click()
    ...
    Uno = "{IvaComp.Proveedor} in " + Desdeprv.Text + " to " + Hastaprv.Text
...
Private Sub Pantalla_Click()
    ...
    Desdeprv.Text = WIndice.List(Indice)
    Hastaprv.Text = WIndice.List(Indice)
    Desdeprv.SetFocus
End Sub
