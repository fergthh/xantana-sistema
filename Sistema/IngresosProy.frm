...
Begin VB.Form PrgIngresosProy 
   AutoRedraw      =   -1  'True
   Caption         =   "Listado de Control de Ingresos por Centro de Costo"
   ClientHeight    =   6960
   ClientLeft      =   3360
   ClientTop       =   1095
   ClientWidth     =   5655
   ...
   Begin VB.Frame Frame2 
      ...
      Begin VB.CommandButton Panta 
         ...
         Height          =   975
         Left            =   240
         MouseIcon       =   "IngresosProy.frx":0000
         MousePointer    =   99  'Custom
         Picture         =   "IngresosProy.frx":030A
         Style           =   1  'Graphical
         TabIndex        =   13
      ...
      Begin VB.CommandButton Consulta 
         ...
         Height          =   975
         Left            =   2640
         MouseIcon       =   "IngresosProy.frx":0B4C
         MousePointer    =   99  'Custom
         Picture         =   "IngresosProy.frx":0E56
         Style           =   1  'Graphical
         TabIndex        =   12
      ...
      Begin VB.CommandButton Impre 
         ...
         Height          =   975
         Left            =   1440
         MouseIcon       =   "IngresosProy.frx":1698
         MousePointer    =   99  'Custom
         Picture         =   "IngresosProy.frx":19A2
         Style           =   1  'Graphical
         TabIndex        =   11
      ...
      Begin VB.CommandButton Cancela 
         ...
         Height          =   975
         Left            =   3720
         MouseIcon       =   "IngresosProy.frx":21E4
         MousePointer    =   99  'Custom
         Picture         =   "IngresosProy.frx":24EE
         Style           =   1  'Graphical
         TabIndex        =   10
         ToolTipText     =   "Salida"
         Top             =   2400
   ...
   Begin Crystal.CrystalReport Listado 
      ...
      _ExtentY        =   741
      _Version        =   262150
      ReportFileName  =   "IngresosProy.rpt"
      Destination     =   1
   ...
   Begin VB.ListBox Pantalla 
      ...
      EndProperty
      Height          =   2400
      ItemData        =   "IngresosProy.frx":2D30
      Left            =   120
      List            =   "IngresosProy.frx":2D37
      TabIndex        =   1
      Top             =   4440
      Visible         =   0   'False
      Width           =   5415
   End
End
Attribute VB_Name = "PrgIngresosProy"
...
Private Sub Proceso_Click()
    ...
    Listado.WindowTitle = "Listado de Control de Ingresos por Proyecto"
    Listado.WindowTop = 0
