...
Begin VB.Form PrgVentProd 
   AutoRedraw      =   -1  'True
   Caption         =   "Listado de Ventas por Articulos"
   ClientHeight    =   5205
   ClientLeft      =   1890
   ClientTop       =   1080
   ClientWidth     =   8145
   ...
   Begin VB.ListBox Pantalla 
      Height          =   1425
      ItemData        =   "VentProd.frx":0000
      Left            =   840
      List            =   "VentProd.frx":0007
      TabIndex        =   3
      Top             =   3600
      Visible         =   0   'False
      Width           =   3735
...
Private Sub Acepta_Click()
    ...
    With rstEstadistica
            ...
            Do
                ...
                If WDesde <= !OrdFecha And !OrdFecha <= Whasta Then
                    Rem WArticulo = Left$(WArticulo + Space$(20), 13)
    ...
    Listado.WindowTitle = "Listado de Ventas por Articulo"
    Listado.WindowTop = -3
    Listado.WindowLeft = -3
    Listado.WindowWidth = Screen.Width
    Listado.WindowHeight = Screen.Height
    
    Uno = "{Estadistica.Articulo} in " + Chr$(34) + Desde.Text + Chr$(34) + " to " + Chr$(34) + Hasta.Text + Chr$(34)
